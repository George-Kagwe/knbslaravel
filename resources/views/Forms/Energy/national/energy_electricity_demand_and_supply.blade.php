          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="demand_supply-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-demand_supplymenu pull-right">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Electricity Demand and Suply</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Demand and Supply</th>
                                           <th>Capacity in Megawatts</th>
                                            <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->electricity_id}}</td>
                                                <td>{{$post->demand_supply}}</td>
                                                <td>{{$post->capacity_megawatts}}</td>
                                              
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo 
                                                    $post->electricity_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.electricity_id);
                              $('[name="demand_supply"]').val(data.demand_supply);
                              $('[name="capacity_megawatts"]').val(data.capacity_megawatts);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Demand and Supply</label>
                                <div class="col-md-9">
                                 
                                 <input name="demand_supply" class="form-control" type="text">
                                  @if ($errors->has('demand_supply'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('demand_supply') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Capacity in Megawatts</label>
                                <div class="col-md-9">
                                  <input name="capacity_megawatts"  class="form-control" type="text">
                                </div>
                              </div>
