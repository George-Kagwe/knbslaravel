 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Installed and Effective Capacity of Electricity</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->capacity_id}}</td>
                                                <td>{{$post->type}}</td>
                                                <td>{{$post->electricity_source}}</td>
                                                <td>{{$post->capacity_megawatts}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo 
                                                    $post->capacity_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchInstalled", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.capacity_id);
                              $('[name="type"]').val(data.type);
                              $('[name="electricity_source"]').val(data.electricity_source);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Electricity Source</label>
                                <div class="col-md-9">
                                  <input name="electricity_source"  class="form-control" type="text">
                                </div>
                              </div>
