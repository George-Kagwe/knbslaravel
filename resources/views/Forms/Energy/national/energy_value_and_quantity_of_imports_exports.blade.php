                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Quantity of Imports and Exports</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->petroleum_id}}</td>
                                                <td>{{$post->type}}</td>
                                                <td>{{$post->petroleum_product}}</td>
                                                <td>{{$post->quantity_tonnes}}</td>
                                                <td>{{$post->value_millions}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo 
                                                    $post->petroleum_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.petroleum_id);
                              $('[name="type"]').val(data.type);
                              $('[name="petroleum_product"]').val(data.petroleum_product);
                              $('[name="quantity_tonnes"]').val(data.quantity_tonnes);  
                              $('[name="value_millions"]').val(data.value_millions);
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="petroleum_product"  class="form-control" type="text">
                                     ...
                                     <div class="form-group">
                                <label class="control-label col-md-3">Quantity in Tonnes</label>
                                <div class="col-md-9">
                                  <input name="quantity_tonnes"  class="form-control" type="text">
                                </div>
                              </div>
                                      <div class="form-group">
                                <label class="control-label col-md-3">Value in Millions</label>
                                <div class="col-md-9">
                                  <input name="value_millions"  class="form-control" type="text">
                                </div>
                              </div>
