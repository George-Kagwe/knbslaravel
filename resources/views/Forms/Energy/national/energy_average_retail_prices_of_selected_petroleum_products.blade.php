                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Average Retail Prices of Selected Petroleum Products</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->retail_price_id}}</td>
                                                <td>{{$post->petroleum_product}}</td>
                                                <td>{{$post->retail_price_ksh}}</td>
                                                <td>{{$post->month}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo 
                                                    $post->retail_price_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.retail_price_id);
                              $('[name="petroleum_product"]').val(data.petroleum_product);
                              $('[name="retail_price_ksh"]').val(data.retail_price_ksh);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Petroleum Product</label>
                                <div class="col-md-9">
                                 
                                 <input name="petroleum_product" class="form-control" type="text">
                                  @if ($errors->has('petroleum_product'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('petroleum_product') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Retail Price in KShs</label>
                                <div class="col-md-9">
                                  <input name="retail_price_ksh"  class="form-control" type="text">
                                </div>
                              </div>
