                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Expenditure Cleaning Refuse</center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="refuse_removal"]').val(data.refuse_removal);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">  refuse removal</label>
                                <div class="col-md-9">
                                 
                                 <input name="refuse_removal" class="form-control" type="text">
                                  @if ($errors->has('refuse_removal'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('refuse_removal') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
