 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Government Forest</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>previous plantation area </th>
                                        <th> area_planted </th>
                                            <th>area_clear_felled</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->govt_id}}</td>
                                                <td>{{$post->previous_plantation_area}}</td>
                                                <td>{{$post->area_planted}}</td>
                                                <td>{{$post->area_clear_felled}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->govt_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      //$('.modal-title').text('Add Person'); // Set Title to Bootstrap modal titles
                      }

                      function edit(id)
                      {
                        var url = '{{ route("fetchforest", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.govt_id);
                              $('[name="previous_plantation_area"]').val(data.previous_plantation_area);

                              $('[name="area_planted"]').val(data.area_planted);
                             
                             $('[name="area_clear_felled"]').val(data.area_clear_felled);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label classs="control-label col-md-3">previous plantation area</label>
                                <div class="col-md-9">
                                 
                                 <input name="previous_plantation_area" class="form-control" type="text">
                                  @if ($errors->has('previous_plantation_area'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('previous_plantation_area') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">area planted</label>
                                <div class="col-md-9">
                                  <input name="area_planted"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">area clear felled</label>
                                <div class="col-md-9">
                                  <input name="area_clear_felled"  class="form-control" type="text">
                                </div>
                              </div>
