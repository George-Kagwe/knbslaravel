                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Num High Risk Environ Impact</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                        ...
                                        <tr>
                                           ...
                                           <th>transport and communication</th>
                                            ...
                                            <th>mining and quarrying</th>
                                             <th>human settlements and Infrastructure</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->risk_id}}</td>
                                                <td>{{$post->transport_and_communication}}</td>
                                                <td>{{$post->energy}}</td>
                                                <td>{{$post->tourism}}</td>
                                                 <td>{{$post->mining_and_quarrying}}</td>
                                                <td>{{$post->human_settlements_and_Infrastructure}}</td>
                                                 <td>{{$post->agriculture_and_forestry}}</td>
                                                <td>{{$post->commerce_and_industry}}</td>
                                                 <td>{{$post->water_resources}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->risk_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.risk_id);
                              $('[name="transport_and_communication"]').val(data.transport_and_communication);

                              $('[name="energy"]').val(data.energy);
                             
                             $('[name="tourism"]').val(data.tourism);

                             $('[name="mining_and_quarrying"]').val(data.mining_and_quarrying);
                             $('[name="human_settlements_and_Infrastructure"]').val(data.human_settlements_and_Infrastructure);
                             $('[name="agriculture_and_forestry"]').val(data.agriculture_and_forestry);
                             $('[name="commerce_and_industry"]').val(data.commerce_and_industry);
                              $('[name="water_resources"]').val(data.water_resources);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">transport and communication</label>
                                <div class="col-md-9">
                                 
                                 <input name="transport_and_communication" class="form-control" type="text">
                                  @if ($errors->has('transport_and_communication'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('transport_and_communication') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">energy</label>
                                <div class="col-md-9">
                                  <input name="energy"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">tourism</label>
                                <div class="col-md-9">
                                  <input name="tourism"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">mining and quarrying</label>
                                <div class="col-md-9">
                                  <input name="mining_and_quarrying"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">human settlements and Infrastructure</label>
                                <div class="col-md-9">
                                  <input name="human_settlements_and_Infrastructure"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">agriculture and forestry</label>
                                <div class="col-md-9">
                                  <input name="agriculture_and_forestry"  class="form-control" type="text">
                                </div>
                              </div>

                               <div class="form-group">
                                <label class="control-label col-md-3">commerce and industry</label>
                                <div class="col-md-9">
                                  <input name="commerce_and_industry"  class="form-control" type="text">
                                </div>
                              </div>

                               <div class="form-group">
                                <label class="control-label col-md-3">water resources</label>
                                <div class="col-md-9">
                                  <input name="water_resources"  class="form-control" type="text">
                                </div>
                              </div>
