                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center> Governance Environmental Crimes Reported to Nema</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->crime_id}}</td>
                                                <td>{{$post->type_of_case}}</td>
                                                <td>{{$post->no_of_cases}}</td>
                                            
                                               
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->crime_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="type_of_case"]').val(data.type_of_case);
                              $('[name="no_of_cases"]').val(data.no_of_cases);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">type_of_case</label>
                                <div class="col-md-9">
                                 
                                 <input name="type_of_case" class="form-control" type="text">
                                  @if ($errors->has(' type_of_case  '))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('type_of_case') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">no of cases</label>
                                <div class="col-md-9">
                                  <input name="no_of_cases"  class="form-control" type="text">
                                </div>
                              </div>
