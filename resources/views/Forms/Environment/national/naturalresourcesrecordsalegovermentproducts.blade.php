 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Record Sale Goverment  Products
</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>soft wood</th>
                                           <th>fuelwood charcoal</th>
                                           <th>power and telegraph</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->record_id}}</td>
                                                <td>{{$post->soft_wood}}</td>
                                                <td>{{$post->fuelwood_charcoal}}</td>
                                                <td>{{$post->power_and_telegraph}}</td>
                                               
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->record_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchproducts", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.record_id);
                              $('[name="soft_wood"]').val(data.soft_wood);
                              $('[name="fuelwood_charcoal"]').val(data.fuelwood_charcoal);
                              $('[name="power_and_telegraph"]').val(data. power_and_telegraph);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">soft wood</label>
                                <div class="col-md-9">
                                 
                                 <input name="soft_wood" class="form-control" type="text">
                                  @if ($errors->has('soft_wood'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('soft_wood') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">fuelwood charcoal</label>
                                <div class="col-md-9">
                                  <input name="fuelwood_charcoal"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">power and telegraph</label>
                                <div class="col-md-9">
                                  <input name="power_and_telegraph"  class="form-control" type="text">
                                </div>
                              </div>
