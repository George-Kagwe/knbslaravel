 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Trends Environment Natural Resources</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>water supply</th>
                                                <th>GDP at current prices</th>
                                           <th>resource as percent of GDP</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->trend_id}}</td>
                                                <td>{{$post->forestry_and_logging}}</td>
                                                <td>{{$post->fishing_and_aquaculture}}</td>

                                                 <td>{{$post->mining_and_quarrying}}</td>
                                                <td>{{$post->water_supply}}</td>
                                                 <td>{{$post->GDP_at_current_prices}}</td>
                                                <td>{{$post->resource_as_percent_of_GDP}}</td>
                                               
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->trend_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchresources", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.trend_id);
                              $('[name="forestry_and_logging"]').val(data.forestry_and_logging);
                              $('[name="fishing_and_aquaculture"]').val(data.fishing_and_aquaculture);
                              $('[name="mining_and_quarrying"]').val(data.mining_and_quarrying);
                              $('[name="water_supply"]').val(data.water_supply);

                              $('[name="GDP_at_current_prices"]').val(data.GDP_at_current_prices);
                              $('[name="resource_as_percent_of_GDP"]').val(data.resource_as_percent_of_GDP);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">forestry and logging</label>
                                <div class="col-md-9">
                                 
                                 <input name="forestry_and_logging" class="form-control" type="text">
                                  @if ($errors->has('forestry_and_logging'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('forestry_and_logging') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">fishing and aquaculture</label>
                                <div class="col-md-9">
                                  <input name="fishing_and_aquaculture"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">water supply</label>
                                <div class="col-md-9">
                                  <input name="water_supply"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">GDP at current prices</label>
                                <div class="col-md-9">
                                  <input name="GDP_at_current_prices"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">resource as percent of GDP</label>
                                <div class="col-md-9">
                                  <input name="resource_as_percent_of_GDP"  class="form-control" type="text">
                                </div>
                              </div>
