 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Average Export Prices Ash</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->average_id}}</td>
                                                <td>{{$post->soda_ash}}</td>
                                                <td>{{$post->fluorspar}}</td>
                                               
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->average_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchenvironment", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.average_id);
                              $('[name="soda_ash"]').val(data.soda_ash);
                              $('[name="fluorspar"]').val(data.fluorspar);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">soda ash</label>
                                <div class="col-md-9">
                                 
                                 <input name="soda_ash" class="form-control" type="text">
                                  @if ($errors->has('soda_ash'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('soda_ash') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">fluors par</label>
                                <div class="col-md-9">
                                  <input name="fluorspar"  class="form-control" type="text">
                                </div>
                              </div>
