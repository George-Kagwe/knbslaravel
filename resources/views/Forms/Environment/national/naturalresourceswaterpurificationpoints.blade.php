                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Environment and Natural Resources Water Purification Points
</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>water purification points</th>
                                           <th>boreholes total</th>
                                            <th>public</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->water_id}}</td>
                                                <td>{{$post->water_purification_points}}</td>
                                                <td>{{$post->boreholes_total}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->water_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.water_id);
                              $('[name="water_purification_points"]').val(data.water_purification_points);
                              $('[name="boreholes_total"]').val(data.boreholes_total);
                              $('[name="public"]').val(data.public);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">water purification points</label>
                                <div class="col-md-9">
                                 
                                 <input name="water_purification_points" class="form-control" type="text">
                                  @if ($errors->has('water_purification_points'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('water_purification_points') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">boreholes total</label>
                                <div class="col-md-9">
                                  <input name="boreholes_total"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">public</label>
                                <div class="col-md-9">
                                  <input name="public"  class="form-control" type="text">
                                </div>
                              </div>
