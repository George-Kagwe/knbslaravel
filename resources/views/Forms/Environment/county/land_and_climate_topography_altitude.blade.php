    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Topography Altitude</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->altitude_topography_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->geography_type}}</td>
                                                <td>{{$post->altitude_in_metres}}</td>                                             
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->altitude_topography_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTopography", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.altitude_topography_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="geography_type"]').val(data.geography_type);
                              $('[name="altitude_in_metres"]').val(data.altitude_in_metres  );
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Geography Type</label>
                                <div class="col-md-9">
                                  <input name="geography_type"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Altitude in Metres</label>
                                <div class="col-md-9">
                                  <input name="altitude_in_metres"  class="form-control" type="text">
                                </div>
                              </div>
