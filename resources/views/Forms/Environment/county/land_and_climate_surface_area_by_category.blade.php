                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Surface Area by Category</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->surface_area_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->categories}}</td>
                                                <td>{{$post->area_sq_km}}</td>                                             
                                                                               

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->surface_area_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                        ...
                        $.get(url, function(data) {
                            var select = $('form select[name=categories]');
                            
                            select.empty();

                            $.each(JSON.parse(data),function(key,value) {
                              
                                 select.append('<option value=' + value.category_id + '>' +value.categories+ '</option>');
                            });
                        });
                    });
                        });
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchCategory", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.surface_area_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="categories"]').val(data.category_id);
                              $('[name="area_sq_km"]').val(data.area_sq_km);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Area PER Sq Km</label>
                                <div class="col-md-9">
                                  <input name="area_sq_km"  class="form-control" type="text">
                                </div>
                              </div>
