                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Land and Climate Temperature</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>County Name</th>
                                           <th>Temperature</th>
                                           <th>Temperature in Celsius Degrees</th>                                        
                                           <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->climate_temperature_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->temperatures}}</td>
                                                <td>{{$post->temp_celsius_degrees }}</td>                                             
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->climate_temperature_id;?>)">Update Record</button>
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          temperatures: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please Select Temparature '
                                                  },
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.climate_temperature_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="temperature_id"]').val(data.temperature_id);
                              $('[name="temp_celsius_degrees"]').val(data.temp_celsius_degrees  );
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="control-label col-md-3">Temparature</label>
                                <div class="col-md-9">
                                  <select class="form-control" id="temperature_id" name="temperature_id">
                                    <option value="">please select</option>
                                    

                                       <?php foreach($temparature as $temparature){?>
                                            
                                                 <option value="{{$temparature->temperature_id}}">{{$temparature->temperatures}}</option>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Tempearature in Celsius Degrees</label>
                                <div class="col-md-9">
                                  <input name="temp_celsius_degrees"  class="form-control" type="text">
                                </div>
                              </div>
