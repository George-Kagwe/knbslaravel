                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Building And Construction Quarterly Civil Engineering Cost Index</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->cost_index_id}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->cost_index_id;?>)">Update Record</button>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="sept"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
