                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Agriculture Total Share Capital</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->total_share_capital_id}}</td>
                                                 <td>{{$post->coffee}}</td>
                                                <td>{{$post->cotton}}</td>
                                                           ...
                                                           <td>{{$post->farm_purchase}}</td>
                                                            <td>{{$post->fisheries}}</td>
                                                             <td>{{$post->other_agricultural}}</td>
                                                              <td>{{$post->total_agriculture}}</td>
                                                               <td>{{$post->saccos}}</td>
                                                                <td>{{$post->consumer}}</td>
                                                                 <td>{{$post->housing}}</td>
                                                                  <td>{{$post->craftsmen}}</td>
                                                                    <td>{{$post->transport}}</td>
                                                                      <td>{{$post->other_non_agricultural}}</td>
                                                                        <td>{{$post->total_non_agricultural}}</td>
                                                                          <td>{{$post->unions}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->total_share_capital_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.total_share_capital_id);
                                     ...
                                     $('[name="farm_purchase"]').val(data.farm_purchase);
                                      $('[name="fisheries"]').val(data.fisheries);
                                       $('[name="other_agricultural"]').val(data.other_agricultural);
                                        $('[name="total_agriculture"]').val(data.total_agriculture);
                                           ...
                                           $('[name="housing"]').val(data.housing);
                                            $('[name="craftsmen"]').val(data.craftsmen);
                                             $('[name="transport"]').val(data.transport);
                                              $('[name="other_non_agricultural"]').val(data.other_non_agricultural);
                                               $('[name="total_non_agricultural"]').val(data.total_non_agricultural);
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3">Fisheries</label>
                                <div class="col-md-9">
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3">Total Agriculture</label>
                                <div class="col-md-9">
                                  <input name="total_agriculture"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
                                <label class="control-label col-md-3">Saccos</label>
                                <div class="col-md-9">
                                ...
                                <div class="col-md-9">
                                  <input name="other_non_agricultural"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
                                <label class="control-label col-md-3">Total Non Agricultural</label>
                                <div class="col-md-9">
                                  <input name="total_non_agricultural"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
