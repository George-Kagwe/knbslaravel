                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Agriculture Production Area Average Yield Tea Type Grower</center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="smallholders"]').val(data.smallholders);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Smallholders</label>
                                <div class="col-md-9">
                                  <input name="smallholders"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
