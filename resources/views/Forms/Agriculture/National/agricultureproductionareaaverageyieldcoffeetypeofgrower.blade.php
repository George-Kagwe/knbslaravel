 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Agriculture Production Area Average Yield Coffee Type Of Grower</center></h5>
                              <br />
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchcooperative", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="cooperatives"]').val(data.cooperatives);
                               $('[name="estates"]').val(data.estates);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cooperatives</label>
                                <div class="col-md-9">
                                  <input name="cooperatives"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Estates</label>
                                <div class="col-md-9">
                                  <input name="estates"  class="form-control" type="text">
                                </div>
                              </div>
