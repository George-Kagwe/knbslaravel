                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Agriculture Price To Producers For Meat Milk</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Beef Third Grade Per KG</th>
                                           <th>Pig Meat Per KG</th>
                                             <th>Whole Milk Per Litre</th>
                                             <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->price_to_producers_for_meat_milk_id}}</td>
                                                 <td>{{$post->beef_third_grade_per_kg}}</td>
                                                      <td>{{$post->pig_meat_per_kg}}</td>
                                                <td>{{$post->whole_milk_per_litre}}</td>
                                                   
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->price_to_producers_for_meat_milk_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.price_to_producers_for_meat_milk_id);
                              $('[name="beef_third_grade_per_kg"]').val(data.beef_third_grade_per_kg);
                              $('[name="pig_meat_per_kg"]').val(data.pig_meat_per_kg);
                               $('[name="whole_milk_per_litre"]').val(data.whole_milk_per_litre);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Beef Third Grade Per KG</label>
                                <div class="col-md-9">
                                 
                                 <input name="beef_third_grade_per_kg" class="form-control" type="text">
                                  @if ($errors->has('beef_third_grade_per_kg'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('beef_third_grade_per_kg') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Pig Meat Per KG</label>
                                <div class="col-md-9">
                                  <input name="pig_meat_per_kg"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Whole milk per litre</label>
                                <div class="col-md-9">
                                  <input name="whole_milk_per_litre"  class="form-control" type="text">
                                </div>
                              </div>
