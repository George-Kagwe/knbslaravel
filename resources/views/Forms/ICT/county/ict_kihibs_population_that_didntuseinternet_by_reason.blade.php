                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($no_internets as $no_net){?>
                                             <tr>
                                                <td>{{$no_net->proportion_id}}</td>
                                                <td>{{$no_net->county_name}}</td>
                                                <td>{{$no_net->too_young}}</td>
                                                <td>{{$no_net->dont_need}}</td>
                                                <td>{{$no_net->lack_skill}}</td>
                                                <td>{{$no_net->expensive}}</td>
                                                <td>{{$no_net->no_internet}}</td>
                                                <td>{{$no_net->culture}}</td>
                                                <td>{{$no_net->control}}</td>
                                                <td>{{$no_net->security}}</td>
                                                <td>{{$no_net->others}}</td>
                                                <td>{{$no_net->not_stated}}</td>
                                                <td>{{$no_net->population}}</td>
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $no_net->proportion_id;?>)">Update Record</button>
                                                </td>
                                              </tr>
                                             <?php }?>
                                       </tbody>
...
$(document).ready( function () {
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          lack_skill: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please count of those that lack_skill '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          expensive: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please count of those that cite its Expensive '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                           ...
                                           no_internet: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of those that have Expensive '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          culture: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of those that say No Internet '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          control: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of those that say Culture '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          security: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of those that cite Control '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          others: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of those that cite others reasons '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopNoNetReason", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="lack_skill"]').val(data.lack_skill);
                              $('[name="expensive"]').val(data.expensive);
                              $('[name="no_internet"]').val(data.no_internet);
                              $('[name="culture"]').val(data.culture);
                              $('[name="control"]').val(data.control);
                              $('[name="security"]').val(data.security);
                      ...
                      function save()
                      {
                        ...
                        else
                        {
                          ...
                          url = "{{ route('updatePopNoNetReason') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none;"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">lack skill</label>
                                <div class="col-md-9">
                                  <input name="lack_skill"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Expensive</label>
                                <div class="col-md-9">
                                  <input name="expensive"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Culture</label>
                                <div class="col-md-9">
                                  <input name="culture"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">No Internet</label>
                                <div class="col-md-9">
                                  <input name="no_internet"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Control</label>
                                <div class="col-md-9">
                                  <input name="control"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
