                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Population with phone and average sims</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>population</th>                                        
                                           <th>average sims</th>
                                           <th>population sims</th>
                                           <th style="width:85px;">Action
                                          </th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                      <?php foreach($sims as $sims){?>
                                             <tr>
                                                <td>{{$sims->proportion_id}}</td>
                                                <td>{{$sims->county_name}}</td>
                                                <td>{{$sims->phone}}</td>
                                                <td>{{$sims->population}}</td>
                                                <td>{{$sims->avg_sims}}</td>
                                                <td>{{$sims->population_sims}}</td>
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $sims->proportion_id;?>)">Update Record</button>
...
//                        $.get(url, function(data) {
  //                          var select = $('form select[name=population]');
                            
    //                        select.empty();

      //                      $.each(JSON.parse(data),function(key,value) {
                              
        //                         select.append('<option value=' + value.subcounty_id + '>' +value.population+ '</option>');
          //                  });
            //            });
              //      });
                //        });
$(document).ready( function () {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopAVGPhoneSims", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="avg_sims"]').val(data.avg_sims);
                              $('[name="population_sims"]').val(data.population_sims);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopAVGPhoneSims') }}";
                        ...
                        else
                        {
                          ...
                          url = "{{ route('updatePopAVGPhoneSims') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">phones</label>
                                <div class="col-md-9">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Average Sims</label>
                                <div class="col-md-9">
                                  <input name="avg_sims"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Average Sim Population</label>
                                <div class="col-md-9">
                                  <input name="population_sims"  class="form-control" type="text">
                                </div>
                              </div>                       
