                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Household Internet by type</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($internet as $internet){?>
                                             <tr>
                                                <td>{{$internet->distribution_id}}</td>
                                                <td>{{$internet->county_name}}</td>
                                                <td>{{$internet->fixed_wired}}</td>
                                                <td>{{$internet->fixed_wireless}}</td>
                                                <td>{{$internet->mobile_broadband}}</td>
                                                <td>{{$internet->mobile}}</td>
                                                <td>{{$internet->other}}</td>
                                                <td>{{$internet->households}}</td>
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $internet->distribution_id;?>)">Update Record</button>
...
//                        $.get(url, function(data) {
  //                          var select = $('form select[name=fixed_wireless]');
                            
    //                        select.empty();

      //                      $.each(JSON.parse(data),function(key,value) {
                              
        //                         select.append('<option value=' + value.subcounty_id + '>' +value.fixed_wireless+ '</option>');
          //                  });
            //            });
              //      });
                //        });
$(document).ready( function () {
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          fixed_wired: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter number of wired connections '
                                                  },
                                                   numeric: {                                                    
                                          ...
                                          fixed_wireless: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a number of wireless connections'
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          mobile_broadband: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a number of mobile broadband connectivity'
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                          ...
                                          mobile: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please count of mobile connectivity '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                                           ...
                                           other: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter count of other internet type '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number'
                                                }
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchHouseholdNetType", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="fixed_wired"]').val(data.fixed_wired);
                              $('[name="fixed_wireless"]').val(data.fixed_wireless);  
                              $('[name="mobile_broadband"]').val(data.mobile_broadband);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeHouseholdNetType') }}";
                        ...
                        else
                        {
                          ...
                          url = "{{ route('updateHouseholdNetType') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Count fixed wired</label>
                                <div class="col-md-9">
                                  <input name="fixed_wired"  class="form-control" type="text">
                                </div>
                              </div>
                           
                              <div class="form-group">
                                <label class="control-label col-md-3">Count of fixed wireless</label>
                                <div class="col-md-9">
                                  <input name="fixed_wireless"  class="form-control" type="text">
                                </div>
                              </div>
                              
                              <div class="form-group">
                                <label class="control-label col-md-3">Mobile broadband</label>
                                <div class="col-md-9">
                                  <input name="mobile_broadband"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
