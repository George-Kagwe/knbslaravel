 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Value of Exports to European Union</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($eu_exports as $eu_exports){?>
                                             <tr>
                                                <td>{{$eu_exports->export_id}}</td>
                                                <td>{{$eu_exports->country}}</td>
                                                <td>{{$eu_exports->value_in_millions}}</td>
                                                <td>{{$eu_exports->year}}</td>                                      
                                               <td>
                                                 <button class="btn btn-success" onclick="edit(<?php echo $eu_exports->export_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceEUExports", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceEUExports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceEUExports') }}";
                        }
