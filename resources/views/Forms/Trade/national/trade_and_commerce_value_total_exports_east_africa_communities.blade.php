 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Value of Exports to East African Communities</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($eac_exports as $eac_exports){?>
                                             <tr>
                                                <td>{{$eac_exports->export_id}}</td>
                                                <td>{{$eac_exports->country}}</td>
                                                <td>{{$eac_exports->value_in_millions}}</td>
                                                <td>{{$eac_exports->year}}</td>                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $eac_exports->export_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceEACExports", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceEACExports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceEACExports') }}";
                        }
