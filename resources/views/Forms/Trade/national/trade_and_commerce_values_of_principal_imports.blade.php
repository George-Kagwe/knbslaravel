 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Value of Principal Imports</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pi_imports as $pi_imports){?>
                                             <tr>
                                                <td>{{$pi_imports->trade_id}}</td>
                                                <td>{{$pi_imports->description}}</td>
                                                <td>{{$pi_imports->quantity}}</td>
                                                <td>{{$pi_imports->year}}</td>                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $pi_imports->trade_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          quantity: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter amount in ksh '
                                                  },
                                                   message: {                                                    
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommercePImports", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommercePImports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommercePImports') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Value in ksh</label>
                                <div class="col-md-9">
