 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Value Principal Domestic Exports</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pde_exports as $pde_exports){?>
                                             <tr>
                                                <td>{{$pde_exports->trade_id}}</td>
                                                <td>{{$pde_exports->description}}</td>
                                                <td>{{$pde_exports->values}}</td>
                                                <td>{{$pde_exports->year}}</td>                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $pde_exports->trade_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommercePDExports", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommercePDExports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommercePDExports') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="values" class="form-control" type="text">
                                </div>
                              </div>
