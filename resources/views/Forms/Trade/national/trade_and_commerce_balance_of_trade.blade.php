 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Balance of Trade</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th> 
                                           <th>Description</th>                   
                                           <th> Balance of Trade Amount in Millions</th>
                                           <th>Year</th>
                                      ...
                                      <tbody>
                                      <?php foreach($balance_of_trade as $balance_of_trade){?>
                                             <tr>
                                                <td>{{$balance_of_trade->trade_id}}</td>
                                                <td>{{$balance_of_trade->description}}</td>
                                                <td>{{$balance_of_trade->amount_in_millions}}</td>
                                                <td>{{$balance_of_trade->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $balance_of_trade->trade_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          description: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please at least a two word description '
                                                  },
                                          ...
                                          amount_in_millions: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter amount in millions '
                                                  },
                                                   message: {                                                    
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceBalance", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceBalance') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceBalance') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Balance of Trade in Millions</label>
                                <div class="col-md-9">
                                 <input name="amount_in_millions" class="form-control" type="number">
                                </div>
                              </div>
