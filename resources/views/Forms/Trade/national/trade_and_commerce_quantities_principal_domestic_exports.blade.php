 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Domestic Exports Quantities</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($domestic_exports as $domestic_exports){?>
                                             <tr>
                                                <td>{{$domestic_exports->trade_id}}</td>
                                                <td>{{$domestic_exports->description}}</td>
                                                <td>{{$domestic_exports->quantity}}</td>
                                                <td>{{$domestic_exports->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $domestic_exports->trade_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceDomesticExport", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceDomesticExport') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceDomesticExport') }}";
                        }
