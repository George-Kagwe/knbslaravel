 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>value of Total Exports to all Destinations</center></h5> 
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($total_exports_destinations as $total){?>
                                             <tr>
                                                <td>{{$total->export_id}}</td>
                                                <td>{{$total->region}}</td>
                                                <td>{{$total->country}}</td>
                                                <td>{{$total->value_in_millions}}</td>
                                                <td>{{$total->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $total->export_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          country: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Must be  value in millions '
                                                  },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceExportsAllDestinations", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.export_id);
                              $('[name="region"]').val(data.region);
                              $('[name="country"]').val(data.country);
                              $('[name="value_in_millions"]').val(data.value_in_millions);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceExportsAllDestinations') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceExportsAllDestinations') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="value_in_millions" class="form-control" type="text">
                                </div>
                              </div>
