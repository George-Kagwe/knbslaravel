 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Quantity of Principal Imports</center></h5> 
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($imports as $imports){?>
                                             <tr>
                                                <td>{{$imports->trade_id}}</td>
                                                <td>{{$imports->commodity}}</td>
                                                <td>{{$imports->unit_of_quantity}}</td>
                                                <td>{{$imports->quantity}}</td>
                                                <td>{{$imports->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $imports->trade_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          unit_of_quantity: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Must be a know unit of quantity '
                                                  },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommercePrincipalImports", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="unit_of_quantity"]').val(data.unit_of_quantity);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommercePrincipalImports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommercePrincipalImports') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Unit of Quantity</label>
                                <div class="col-md-9">
                                 <input name="unit_of_quantity" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
