 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Import of Trade among African Countries</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($imports as $imports){?>
                                             <tr>
                                                ...
                                                <td>{{$imports->values}}</td>
                                                <td>{{$imports->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $imports->import_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          country: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Must be a know country '
                                                  },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTradeAndCommerceImports", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.import_id);
                              $('[name="zones"]').val(data.zones);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTradeAndCommerceImports') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTradeAndCommerceImports') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="zones" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
