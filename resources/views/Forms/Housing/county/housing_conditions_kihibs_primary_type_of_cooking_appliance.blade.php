                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Primary Type of Cooking Appliance</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Stone Fire</th>                                        
                                           <th>IMP Stone Fire</th>
                                           <th>Ordinary Jiko</th>
                                           <th>Improved Jiko</th>
                                           <th>Stove</th>
                                            <th>Gas Cooker</th>
                                            <th>Electric Cooker</th>
                                            <th>Electric Gas Cooker</th>
                                            <th>Other</th>
                                           <th>Not Stated</th> 
                                           <th>Households</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->appliance_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->stone_fire}}</td>
                                                                             
                                                <td>{{$post->imp_stone_fire}}</td>   


                                                 <td>{{$post->ordinary_jiko}}</td>
                                                <td>{{$post->improved_jiko}}</td>
                                                <td>{{$post->stove}}</td>                                             
                                           
                                                 <td>{{$post->gas_cooker}}</td>
                                                <td>{{$post->electric_cooker}}</td>
                                                <td>{{$post->elec_gas_cooker}}</td>                                             
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->appliance_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.appliance_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="stone_fire"]').val(data.stone_fire);
                              $('[name="imp_stone_fire"]').val(data.imp_stone_fire);   
                              $('[name="ordinary_jiko"]').val(data.ordinary_jiko);
                              $('[name="improved_jiko"]').val(data.improved_jiko);
                              $('[name="stove"]').val(data.stove);
                              $('[name="gas_cooker"]').val(data.gas_cooker);    
                              $('[name="electric_cooker"]').val(data.electric_cooker);
                              $('[name="elec_gas_cooker"]').val(data.elec_gas_cooker);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Stone Fire</label>
                                <div class="col-md-9">
                                  <input name="stone_fire"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">IMP Stone Fire</label>
                                <div class="col-md-9">
                                  <input name="imp_stone_fire"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Ordinary Jiko</label>
                                <div class="col-md-9">
                                  <input name="ordinary_jiko"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Improved Jiko</label>
                                <div class="col-md-9">
                                  <input name="improved_jiko"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Stove</label>
                                <div class="col-md-9">
                                  <input name="stove"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Gas Cooker</label>
                                <div class="col-md-9">
                                  <input name="gas_cooker"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Electric Cooker</label>
                                <div class="col-md-9">
                                  <input name="electric_cooker"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Electrical Gas Cooker</label>
                                <div class="col-md-9">
                                  <input name="elec_gas_cooker"  class="form-control" type="text">
                                </div>
                              </div>
