    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Households in Rented Dwellings</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Parastatal</th>
                                           <th>Company Directly</th>
                                           <th>Company Agent</th>
                                     
                                           <th>Individual Directlt</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->govt_national}}</td>
                                                <td>{{$post->govt_county}}</td>                                             
                                                <td>{{$post->parastatal}}</td>   


                                                 <td>{{$post->company_directly}}</td>
                                                <td>{{$post->company_agent}}</td>
                                                <td>{{$post->individual_directly}}</td>                                             
                                                <td>{{$post->individual_agent}}</td>  
                                                 <td>{{$post->other}}</td>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchDwelling", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="govt_national"]').val(data.govt_national);
                              $('[name="govt_county"]').val(data.govt_county  );
                              $('[name="parastatal"]').val(data.parastatal);   
                              $('[name="company_directly"]').val(data.company_directly);
                              $('[name="company_agent"]').val(data.company_agent  );
                        
                              $('[name="individual_directly"]').val(data.individual_directly);
                              $('[name="individual_agent"]').val(data.individual_agent  );
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">National Government</label>
                                <div class="col-md-9">
                                  <input name="govt_national"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">County Government</label>
                                <div class="col-md-9">
                                  <input name="govt_county"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Parastatal</label>
                                <div class="col-md-9">
                                  <input name="parastatal"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Company Directly</label>
                                <div class="col-md-9">
                                  <input name="company_directly"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Company Agent</label>
                                <div class="col-md-9">
                                  <input name="company_agent"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Individual Directly</label>
                                <div class="col-md-9">
                                  <input name="individual_directly"  class="form-control" type="text">
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3">Individual Agent</label>
                                <div class="col-md-9">
                                  <input name="individual_agent"  class="form-control" type="text">
                                </div>
                              </div>
