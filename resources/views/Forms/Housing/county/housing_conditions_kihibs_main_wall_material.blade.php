                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Main Wall Material</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->material_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->lime_stone}}</td>
                                                                             
                                                <td>{{$post->bricks}}</td>   


                                                 <td>{{$post->cement_blocks}}</td>
                                                <td>{{$post->cement_finish}}</td>
                                                <td>{{$post->wood}}</td>                                             
                                           
                                                 <td>{{$post->adobe}}</td>
                                                <td>{{$post->iron_sheets}}</td>
                                                <td>{{$post->bamboo}}</td>                                             
                                                <td>{{$post->stone}}</td>
                                                <td>{{$post->cane}}</td>  
                                                 <td>{{$post->plywood}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->material_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="lime_stone"]').val(data.lime_stone);
                     
                              $('[name="bricks"]').val(data.bricks);   
                              $('[name="cement_blocks"]').val(data.cement_blocks);
                              $('[name="cement_finish"]').val(data.cement_finish);
                        
                              $('[name="wood"]').val(data.wood);
                          
                              $('[name="adobe"]').val(data.adobe);    
                              $('[name="iron_sheets"]').val(data.iron_sheets);
                              $('[name="bamboo"]').val(data.bamboo);

                              $('[name="stone"]').val(data.stone  );    
                              $('[name="cane"]').val(data.cane);
                              $('[name="plywood"]').val(data.plywood);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Limestone</label>
                                <div class="col-md-9">
                                  <input name="lime_stone"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Bricks</label>
                                <div class="col-md-9">
                                  <input name="bricks"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Cement Blocks</label>
                                <div class="col-md-9">
                                  <input name="cement_blocks"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Cement Finish</label>
                                <div class="col-md-9">
                                  <input name="cement_finish"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Wood</label>
                                <div class="col-md-9">
                                  <input name="wood"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Adobe</label>
                                <div class="col-md-9">
                                  <input name="adobe"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Iron Sheets</label>
                                <div class="col-md-9">
                                  <input name="iron_sheets"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="bamboo"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Stone</label>
                                <div class="col-md-9">
                                  <input name="stone"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cane</label>
                                <div class="col-md-9">
                                  <input name="cane"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Plywood</label>
                                <div class="col-md-9">
                                  <input name="plywood"  class="form-control" type="text">
                                </div>
                              </div>
