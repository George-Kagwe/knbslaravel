                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Main Source of Cooking Fuel</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->charcoal}}</td>                                             
                                                 ...
                                                 <td>{{$post->shrubs}}</td>
                                                <td>{{$post->animal_dung}}</td>
                                                <td>{{$post->crop_residue}}</td>                                             
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="firewood"]').val(data.firewood);
                              $('[name="electricity"]').val(data.electricity  );
                              $('[name="lpg"]').val(data.lpg);   
                              $('[name="biogas"]').val(data.biogas);
                              $('[name="kerosene"]').val(data.kerosene);
                        
                              $('[name="charcoal"]').val(data.charcoal);
                          
                              $('[name="shrubs"]').val(data.shrubs);    
                              $('[name="animal_dung"]').val(data.animal_dung);
                              $('[name="crop_residue"]').val(data.crop_residue);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Firewood</label>
                                <div class="col-md-9">
                                  <input name="firewood"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Lpg</label>
                                <div class="col-md-9">
                                  <input name="lpg"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Charcoal</label>
                                <div class="col-md-9">
                                  <input name="charcoal"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Shrubs</label>
                                <div class="col-md-9">
                                  <input name="shrubs"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Animal Dung</label>
                                <div class="col-md-9">
                                  <input name="animal_dung"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Crop Residue</label>
                                <div class="col-md-9">
                                  <input name="crop_residue"  class="form-control" type="text">
                                </div>
                              </div>
