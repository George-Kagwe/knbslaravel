                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->not_stated}}</td>  
                                                 <td>{{$post->mean_rooms}}</td>
                                                <td>{{$post->households}}</td>
                                                <td>{{$post->persons_per_room}}</td>                                             
                                                               

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->room_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.room_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="one"]').val(data.one);
                              $('[name="two"]').val(data.two  );
                              $('[name="three"]').val(data.three);   
                              $('[name="four"]').val(data.four);
                              $('[name="five"]').val(data.five  );
                              $('[name="year"]').val(data.year);    
                              $('[name="six_plus"]').val(data.six_plus);
                              $('[name="not_stated"]').val(data.not_stated  );
                              $('[name="mean_rooms"]').val(data.mean_rooms);    
                              $('[name="households"]').val(data.households);
                              $('[name="persons_per_room"]').val(data.persons_per_room);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">One</label>
                                <div class="col-md-9">
                                  <input name="one"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Two</label>
                                <div class="col-md-9">
                                  <input name="two"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Three</label>
                                <div class="col-md-9">
                                  <input name="three"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Four</label>
                                <div class="col-md-9">
                                  <input name="four"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Five</label>
                                <div class="col-md-9">
                                  <input name="five"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Six Plus</label>
                                <div class="col-md-9">
                                  <input name="six_plus"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Mean Rooms</label>
                                <div class="col-md-9">
                                  <input name="mean_rooms"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Persons Per Room</label>
                                <div class="col-md-9">
                                  <input name="persons_per_room"  class="form-control" type="text">
                                </div>
                              </div>
