                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Housing Condition by Type of Housing Unit</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->unit_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="bungalow"]').val(data.bungalow);
                              $('[name="flat"]').val(data.flat  );
                              $('[name="maisonnette"]').val(data.maisonnette);   
                              $('[name="swahili"]').val(data.swahili);
                              $('[name="shanty"]').val(data.shanty  );
                        
                              $('[name="manyatta"]').val(data.manyatta);
                              $('[name="landhi"]').val(data.landhi  );
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Bungalow</label>
                                <div class="col-md-9">
                                  <input name="bungalow"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Maisonnette</label>
                                <div class="col-md-9">
                                  <input name="maisonnette"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Swahili</label>
                                <div class="col-md-9">
                                  <input name="swahili"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Shanty</label>
                                <div class="col-md-9">
                                  <input name="shanty"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Manyatta</label>
                                <div class="col-md-9">
                                  <input name="manyatta"  class="form-control" type="text">
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3">Landhi</label>
                                <div class="col-md-9">
                                  <input name="landhi"  class="form-control" type="text">
                                </div>
                              </div>
