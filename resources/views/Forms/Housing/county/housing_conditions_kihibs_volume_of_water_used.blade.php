                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Volume of Water Used</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                             ...
                                             <th>0 - 1000 Litres</th>                                        
                                             <th>1001 - 2000 Litres</th>
                                             <th>2001 - 3000 Litres</th> 
                                              <th>Over 3000 Litres</th>
                                              <th>Not Stated</th>
                                             <th>Households</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->volume_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->lit_0_1000}}</td>
                                                <td>{{$post->lit_1001_2000}}</td>   
                                                <td>{{$post->lit_2001_3000}}</td>
                                                <td>{{$post->over_3000_lit}}</td>
                                                <td>{{$post->not_stated}}</td>
                                                <td>{{$post->households}}</td>  

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->volume_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.volume_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="lit_0_1000"]').val(data.lit_0_1000);
                              $('[name="lit_1001_2000"]').val(data.lit_1001_2000);   
                              $('[name="lit_2001_3000"]').val(data.lit_2001_3000);
                              $('[name="over_3000_lit"]').val(data.over_3000_lit);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">0 - 1000 Litres</label>
                                <div class="col-md-9">
                                  <input name="lit_0_1000"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">1001 - 2000 Litres</label>
                                <div class="col-md-9">
                                  <input name="lit_1001_2000"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">2001-3000 Litres</label>
                                <div class="col-md-9">
                                  <input name="lit_2001_3000"  class="form-control" type="text">
                                </div>
                              </div>

                                <div class="form-group">
                                <label class="control-label col-md-3">Over 3000 Litres</label>
                                <div class="col-md-9">
                                  <input name="over_3000_lit"  class="form-control" type="text">
                                </div>
                              </div>
