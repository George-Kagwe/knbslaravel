                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Sharing of Toilet Facility</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->proportion_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->shared_toilet}}</td>
                                                <td>{{$post->not_shared}}</td>   
                                                <td>{{$post->not_stated}}</td>
                                                <td>{{$post->households}}</td>  

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->proportion_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="shared_toilet"]').val(data.shared_toilet);
                              $('[name="not_shared"]').val(data.not_shared);   
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Shared Toilet</label>
                                <div class="col-md-9">
                                  <input name="shared_toilet"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Not Shared</label>
                                <div class="col-md-9">
                                  <input name="not_shared"  class="form-control" type="text">
                                </div>
                              </div>
