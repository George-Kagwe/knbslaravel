                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Methods used to make Water Safer</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->add_bleach}}</td>   


                                                 <td>{{$post->water_filter}}</td>
                                                <td>{{$post->solar}}</td>
                                                <td>{{$post->sieve_cloth}}</td>                                             
                                           
                                                 <td>{{$post->stand_settle}}</td>
                                                <td>{{$post->other}}</td>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="boil"]').val(data.boil);
                     
                              $('[name="add_bleach"]').val(data.add_bleach);   
                              $('[name="water_filter"]').val(data.water_filter);
                              $('[name="solar"]').val(data.solar);
                        
                              $('[name="sieve_cloth"]').val(data.sieve_cloth);
                          
                              $('[name="stand_settle"]').val(data.stand_settle);    
                              $('[name="other"]').val(data.other);
                          
                          
                              $('[name="nothing"]').val(data.nothing);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Boil</label>
                                <div class="col-md-9">
                                  <input name="boil"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Add Bleach</label>
                                <div class="col-md-9">
                                  <input name="add_bleach"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Water Filter</label>
                                <div class="col-md-9">
                                  <input name="water_filter"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Solar</label>
                                <div class="col-md-9">
                                  <input name="solar"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">Sieve Cloth</label>
                                <div class="col-md-9">
                                  <input name="sieve_cloth"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">Stand Settle</label>
                                <div class="col-md-9">
                                  <input name="stand_settle"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">Nothing</label>
                                <div class="col-md-9">
                                  <input name="nothing"  class="form-control" type="text">
                                </div>
                              </div>
