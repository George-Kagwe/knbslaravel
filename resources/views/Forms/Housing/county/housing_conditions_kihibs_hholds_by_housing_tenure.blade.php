                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>County Name</th>
                                           <th>Owener Occupier</th>
                                           <th>Pays Rent</th>                                        
                                           <th>No Rent Consent</th>
                                           <th>No Rent Squatting</th>
                                           <th>Not Stated</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->tenure_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->owner_occupier}}</td>
                                                <td>{{$post->pays_rent}}</td>                                             
                                                <td>{{$post->no_rent_consent}}</td>   


                                                 <td>{{$post->no_rent_squatting}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->tenure_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.tenure_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="owner_occupier"]').val(data.owner_occupier);
                              $('[name="pays_rent"]').val(data.pays_rent  );
                              $('[name="no_rent_consent"]').val(data.no_rent_consent);   
                              $('[name="no_rent_squatting"]').val(data.no_rent_squatting);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Owner Occupier</label>
                                <div class="col-md-9">
                                  <input name="owner_occupier"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Pays Rent</label>
                                <div class="col-md-9">
                                  <input name="pays_rent"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">No Rent Consent</label>
                                <div class="col-md-9">
                                  <input name="no_rent_consent"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">No Rent Squatting</label>
                                <div class="col-md-9">
                                  <input name="no_rent_squatting"  class="form-control" type="text">
                                </div>
                              </div>
