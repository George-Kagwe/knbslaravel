                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Waste Disposal Method</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Dumped Compound</th>
                                           <th>Dumped Street</th>
                                            <th>Dumped Latrine</th>
                                            <th>Burnt</th>
                                            <th>Buried</th>
                                            <th>Other</th>
                                           <th>Not Stated</th> 
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->method_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->county_gov}}</td>
                                                                             
                                                <td>{{$post->community}}</td>   


                                                 <td>{{$post->private_co}}</td>
                                                <td>{{$post->dumped_compound}}</td>
                                                <td>{{$post->dumped_street}}</td>                                             
                                           
                                                 <td>{{$post->dumped_latrine}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->method_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.method_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="county_gov"]').val(data.county_gov);
                              $('[name="community"]').val(data.community);   
                              $('[name="private_co"]').val(data.private_co);
                              $('[name="dumped_compound"]').val(data.dumped_compound);
                              $('[name="dumped_street"]').val(data.dumped_street);
                              $('[name="dumped_latrine"]').val(data.dumped_latrine);    
                              $('[name="burnt"]').val(data.burnt);
                              $('[name="buried"]').val(data.buried);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="county_gov"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Private Company</label>
                                <div class="col-md-9">
                                  <input name="private_co"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Dumped Compound</label>
                                <div class="col-md-9">
                                  <input name="dumped_compound"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Dumped Street</label>
                                <div class="col-md-9">
                                  <input name="dumped_street"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">Dumped Latrine</label>
                                <div class="col-md-9">
                                  <input name="dumped_latrine"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Burnt</label>
                                <div class="col-md-9">
                                  <input name="burnt"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Buried</label>
                                <div class="col-md-9">
                                  <input name="buried"  class="form-control" type="text">
                                </div>
                              </div>
