                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="cement"]').val(data.cement  );
                              $('[name="wood"]').val(data.wood);   
                              $('[name="cow_dung"]').val(data.cow_dung);
                              $('[name="sand"]').val(data.sand  );
                        
                              $('[name="carpet"]').val(data.carpet);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cement</label>
                                <div class="col-md-9">
                                  <input name="cement"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cow Dung</label>
                                <div class="col-md-9">
                                  <input name="cow_dung"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Sand</label>
                                <div class="col-md-9">
                                  <input name="sand"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Carpet</label>
                                <div class="col-md-9">
                                  <input name="carpet"  class="form-control" type="text">
                                </div>
                              </div>
