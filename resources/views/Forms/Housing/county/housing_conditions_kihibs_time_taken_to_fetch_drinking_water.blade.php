                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Time taken to Fetch Drinking Water</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->zero}}</td>
                                                <td>{{$post->less_thirty_min}}</td>   
                                                <td>{{$post->over_thirty_min}}</td>
                                                <td>{{$post->not_stated}}</td>
                                                <td>{{$post->households}}</td>  

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->time_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.time_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="zero"]').val(data.zero);
                              $('[name="less_thirty_min"]').val(data.less_thirty_min);   
                              $('[name="over_thirty_min"]').val(data.over_thirty_min);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Zero</label>
                                <div class="col-md-9">
                                  <input name="zero"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Less than 30 mins</label>
                                <div class="col-md-9">
                                  <input name="less_thirty_min"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">Over 30 Mins</label>
                                <div class="col-md-9">
                                  <input name="over_thirty_min"  class="form-control" type="text">
                                </div>
                              </div>
