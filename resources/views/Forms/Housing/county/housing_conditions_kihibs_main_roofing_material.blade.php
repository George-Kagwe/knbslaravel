        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="sidebar-footer hidden-small">
              <a data-toggle="tooltip" data-plamud="top" title="Settings">
                <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
              </a>
              <a data-toggle="tooltip" data-plamud="top" title="FullScreen">
                <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
              </a>
              <a data-toggle="tooltip" data-plamud="top" title="Lock">
                <span class="glyphicon glyphicon-eye-close" aria-hidden="true"></span>
              </a>
              <a data-toggle="tooltip" data-plamud="top" title="Logout" href="login.html">
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="grass"]').val(data.grass);
                              $('[name="mud"]').val(data.mud  );
                              $('[name="iron_sheets"]').val(data.iron_sheets);   
                              $('[name="tin_cans"]').val(data.tin_cans  );
                              $('[name="sheet"]').val(data.sheet  );
                        
                              $('[name="concrete"]').val(data.concrete);
                          
                              $('[name="tiles"]').val(data.tiles);    
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Grass</label>
                                <div class="col-md-9">
                                  <input name="grass"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Mud</label>
                                <div class="col-md-9">
                                  <input name="mud"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Tin Cans</label>
                                <div class="col-md-9">
                                  <input name="tin_cans"  class="form-control" type="text">
                                </div>
                              </div>
                                ...
                                <div class="col-md-9">
                                  <input name="sheet"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Concrete</label>
                                <div class="col-md-9">
                                  <input name="concrete"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Tiles</label>
                                <div class="col-md-9">
                                  <input name="tiles"  class="form-control" type="text">
                                </div>
                              </div>
