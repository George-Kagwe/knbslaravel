    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Main Source of Lighting Fuel</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Generator</th>
                                           <th>Cow Dung</th>
                                           <th>Paraffin Lantern</th>
                                     
                                           <th>Parrafin Tin Lamp</th>
                                          
                                           <th>Parrafin Pressure Lamp</th>
                                            <th>Fuel Wood</th>
                                            <th>Gas Lamp</th>
                                            <th>Battery Lamp</th>
                                            <th>Candles</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->generator}}</td>   
                                                 ...
                                                 <td>{{$post->solar_energy}}</td>
                                                <td>{{$post->paraffin_lantern}}</td>
                                                <td>{{$post->paraffin_tin_lamp}}</td>                                             
                                           
                                                 <td>{{$post->paraffin_pressure_lamp}}</td>
                                                <td>{{$post->fuel_wood}}</td>
                                                <td>{{$post->gas_lamp}}</td>                                             
                                                <td>{{$post->battery_lamp}}</td>
                                                <td>{{$post->candles}}</td>  
                                                 <td>{{$post->biogas}}</td>
                                                <td>{{$post->other}}</td>  
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchLighting", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="electricity"]').val(data.electricity);
                     
                              $('[name="generator"]').val(data.generator);   
                              $('[name="solar_energy"]').val(data.solar_energy);
                              $('[name="paraffin_lantern"]').val(data.paraffin_lantern);
                        
                              $('[name="paraffin_tin_lamp"]').val(data.paraffin_tin_lamp);
                          
                              $('[name="paraffin_pressure_lamp"]').val(data.paraffin_pressure_lamp);    
                              $('[name="fuel_wood"]').val(data.fuel_wood);
                              $('[name="gas_lamp"]').val(data.gas_lamp);

                              $('[name="battery_lamp"]').val(data.battery_lamp);    
                              $('[name="candles"]').val(data.candles);
                              $('[name="biogas"]').val(data.biogas);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Electricity</label>
                                <div class="col-md-9">
                                  <input name="electricity"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="generator"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Solar Energy</label>
                                <div class="col-md-9">
                                  <input name="solar_energy"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Paraffin Lantern</label>
                                <div class="col-md-9">
                                  <input name="paraffin_lantern"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Paraffin Tin lamp</label>
                                <div class="col-md-9">
                                  <input name="paraffin_tin_lamp"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Paraffin Pressure Lamp</label>
                                <div class="col-md-9">
                                  <input name="paraffin_pressure_lamp"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Fuel Wood</label>
                                <div class="col-md-9">
                                  <input name="fuel_wood"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Gas Lamp</label>
                                <div class="col-md-9">
                                  <input name="gas_lamp"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Battery Lamp</label>
                                <div class="col-md-9">
                                  <input name="battery_lamp"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Candles</label>
                                <div class="col-md-9">
                                  <input name="candles"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Biogas</label>
                                <div class="col-md-9">
                                  <input name="biogas"  class="form-control" type="text">
                                </div>
                              </div>
