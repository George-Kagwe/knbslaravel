                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Main Toilet Facility</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Compositing Toilet</th>
                                            <th>Somewhere Else</th>
                                            <th>Unknown Place</th>
                                            <th>Without SLab</th>
                                            <th>Bucket Toilet</th>
                                           <th>Hanging Toilet</th>
                                             <th>Bush</th>
                                             <th>Other</th>
                                            <th>Not Stated</th> 
                                           <th>Households</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->facility_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->piped_sewer}}</td>
                                                                             
                                                <td>{{$post->septic_tank}}</td>   


                                                 <td>{{$post->latrine}}</td>
                                                <td>{{$post->vip}}</td>
                                                <td>{{$post->latrine_slab}}</td>                                             
                                           
                                                 <td>{{$post->composting_toilet}}</td>
                                                <td>{{$post->somewhere_else}}</td>
                                                <td>{{$post->unknown_place}}</td>                                             
                                                <td>{{$post->without_slab}}</td>
                                                <td>{{$post->bucket_toilet}}</td>  
                                                 <td>{{$post->hanging_toilet}}</td>
                                                    <td>{{$post->bush}}</td>
                                                <td>{{$post->other}}</td>  
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->facility_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="piped_sewer"]').val(data.piped_sewer);
                     
                              $('[name="septic_tank"]').val(data.septic_tank);   
                              $('[name="latrine"]').val(data.latrine);
                              $('[name="vip"]').val(data.vip);
                        
                              $('[name="latrine_slab"]').val(data.latrine_slab);
                          
                              $('[name="composting_toilet"]').val(data.composting_toilet);    
                              $('[name="somewhere_else"]').val(data.somewhere_else);
                              $('[name="unknown_place"]').val(data.unknown_place);

                              $('[name="without_slab"]').val(data.without_slab  );    
                              $('[name="bucket_toilet"]').val(data.bucket_toilet);
                              $('[name="hanging_toilet"]').val(data.hanging_toilet);
                              $('[name="bush"]').val(data.bush);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Piped Sewer</label>
                                <div class="col-md-9">
                                  <input name="piped_sewer"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="septic_tank"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Latrine</label>
                                <div class="col-md-9">
                                  <input name="latrine"  class="form-control" type="text">
                                </div>
                              </div>
                                ...
                                <div class="col-md-9">
                                  <input name="vip"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Latrine Slab</label>
                                <div class="col-md-9">
                                  <input name="latrine_slab"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Compositing Toilet</label>
                                <div class="col-md-9">
                                  <input name="composting_toilet"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Somewhere Else</label>
                                <div class="col-md-9">
                                  <input name="somewhere_else"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Unknown Place</label>
                                <div class="col-md-9">
                                  <input name="unknown_place"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Without Slab</label>
                                <div class="col-md-9">
                                  <input name="without_slab"  class="form-control" type="text">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Bucket Toilet</label>
                                <div class="col-md-9">
                                  <input name="bucket_toilet"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Hanging Toilet</label>
                                <div class="col-md-9">
                                  <input name="hanging_toilet"  class="form-control" type="text">
                                </div>
                              </div>

                                  <div class="form-group">
                                <label class="control-label col-md-3">Bush</label>
                                <div class="col-md-9">
                                  <input name="bush"  class="form-control" type="text">
                                </div>
                              </div>
