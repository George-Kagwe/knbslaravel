 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Number of Refugees by Age and Sex<center></h5>
                              <br />
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchRefugees", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="children"]').val(data.children);
                              $('[name="adult"]').val(data.adult);
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 ...
                                 <input name="children" class="form-control" type="text">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Adult</label>
                                <div class="col-md-9">
                                  <input name="adult"  class="form-control" type="text">
                                </div>
                              </div>
