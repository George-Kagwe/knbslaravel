                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Prevelance of Female Circumcision and Type</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Age</th>
                                           <th>Cut no Flesh Removed</th>
                                           <th>Cut Flesh removed</th>
                                          <th>Sewn Closed</th>
                                          <th>Others</th>
                                          <th>Percentage of Women Circumcised</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->persons_id}}</td>
                                                <td>{{$post->age}}</td>
                                                <td>{{$post->cut_no_flesh_removed}}</td>
                                                <td>{{$post->cut_flesh_removed}}</td>
                                                <td>{{$post->sewn_closed}}</td>
                                                <td>{{$post->others}}</td>
                                                 <td>{{$post->percentage_women_circumcised}}</td>                                     

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->persons_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.persons_id);
                              $('[name="age"]').val(data.age);
                              $('[name="cut_no_flesh_removed"]').val(data.cut_no_flesh_removed);
                              $('[name="cut_flesh_removed"]').val(data.cut_flesh_removed);
                              $('[name="sewn_closed"]').val(data.sewn_closed);
                              $('[name="others"]').val(data.others);
                              $('[name="percentage_women_circumcised"]').val(data.percentage_women_circumcised);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cut no Flesh Removed</label>
                                <div class="col-md-9">
                                  <input name="cut_no_flesh_removed"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Cut Flesh Removed</label>
                                <div class="col-md-9">
                                  <input name="cut_flesh_removed"  class="form-control" type="text">
                                </div>
                              </div>
                                  

                                <div class="form-group">
                                <label class="control-label col-md-3">Sewn Closed</label>
                                <div class="col-md-9">
                                  <input name="sewn_closed"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="others"  class="form-control" type="text">
                                   ...
                                   <div class="form-group">
                                <label class="control-label col-md-3">Percentage of women circumcised</label>
                                <div class="col-md-9">
                                  <input name="percentage_women_circumcised"  class="form-control" type="text">
                                </div>
                              </div>     
