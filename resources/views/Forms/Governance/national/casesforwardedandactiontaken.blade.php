                     ...
                     <div class="col-lg-12">
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->action_id}}</td>
                                                <td>{{$post->action_taken}}</td>
                                                <td>{{$post->no_of_recommendations}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo 
                                                    $post->action_id;?>)">Update Record</button>
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">No of Recommendations</label>
                                <div class="col-md-9">
                                  <input name="no_of_recommendations"  class="form-control" type="text">
                                </div>
                              </div>
