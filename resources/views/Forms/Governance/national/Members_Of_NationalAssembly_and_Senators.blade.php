                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Members of National Assembly and Senators<center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="women_percentage"]').val(data.women_percentage);                                         
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div class="form-group">
                                <label class="control-label col-md-3">Percentage of Women</label>
                                <div class="col-md-9">
                                  <input name="women_percentage"  class="form-control" type="text">
                                </div>
                              </div>
