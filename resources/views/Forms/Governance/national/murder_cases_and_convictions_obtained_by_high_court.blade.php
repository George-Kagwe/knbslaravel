                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Murder Cases and Convictions Obtained by High court</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Court Station </th>
                                           <th>Registered Murder Cases</th>
                                           <th>Murder Convictions Obtained </th>                                           
                                           <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->reg_murder_convictions_obtained_id}}</td>
                                                <td>{{$post->court_station}}</td>
                                                <td>{{$post->registered_murder_cases}}</td>
                                                <td>{{$post->murder_convictions_obtained}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->reg_murder_convictions_obtained_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.reg_murder_convictions_obtained_id);
                              $('[name="court_station"]').val(data.court_station);
                              $('[name="registered_murder_cases"]').val(data.registered_murder_cases);
                              $('[name="murder_convictions_obtained"]').val(data.murder_convictions_obtained);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Court Station</label>
                                <div class="col-md-9">
                                 
                                 <input name="court_station" class="form-control" type="text">
                                  @if ($errors->has('court_station'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('court_station') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Registered  Cases</label>
                                <div class="col-md-9">
                                  <input name="registered_murder_cases"  class="form-control" type="text">
                                </div>
                              </div>
                            
                                  <div class="form-group">
                                <label class="control-label col-md-3">Murder Convictions Obtained</label>
                                <div class="col-md-9">
                                  <input name="murder_convictions_obtained"  class="form-control" type="text">
                                </div>
                              </div>
