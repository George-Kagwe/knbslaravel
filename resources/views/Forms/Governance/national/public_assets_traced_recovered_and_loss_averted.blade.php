                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Public Assets traced,recovered and Loss averted</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Public Assets Traced</th>
                                           <th>Public Assets Recovered</th>
                                           <th>Loss Averted</th>                                           
                                           <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->public_assets_traced}}</td>
                                                <td>{{$post->public_assets_recovered}}</td>
                                                <td>{{$post->loss_averted}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->category_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.category_id);
                              $('[name="public_assets_traced"]').val(data.public_assets_traced);
                              $('[name="public_assets_recovered"]').val(data.public_assets_recovered);
                              $('[name="loss_averted"]').val(data.loss_averted);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Public Assets Traced</label>
                                <div class="col-md-9">
                                 
                                 <input name="public_assets_traced" class="form-control" type="text">
                                  @if ($errors->has('public_assets_traced'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('public_assets_traced') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Public Assets Recovered</label>
                                <div class="col-md-9">
                                  <input name="public_assets_recovered"  class="form-control" type="text">
                                </div>
                              </div>
                            
                                  <div class="form-group">
                                <label class="control-label col-md-3">Loss Averted</label>
                                <div class="col-md-9">
                                  <input name="loss_averted"  class="form-control" type="text">
                                </div>
                              </div>
