                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Daily Average Population of Prisoners by Sex<center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->daily_population_prisoners_id}}</td>
                                                <td>{{$post->category}}</td>
                                                <td>{{$post->male}}</td>
                                                <td>{{$post->female}}</td>
                                                <td>{{$post->year}}</td>                                      
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->daily_population_prisoners_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.daily_population_prisoners_id);
