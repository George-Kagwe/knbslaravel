                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Knowledge and Prevelance of Fmale Circumcision</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>Age</th>
                                           <th>Percentage of Women heard of FC</th>
                                           <th>Percentage of Women not heard of FC</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->woman_id}}</td>
                                                <td>{{$post->age}}</td>
                                                <td>{{$post->percentage_women_heard_of_FC}}</td>
                                                <td>{{$post->percentage_women_not_heard_of_FC}}</td>
                                                <td>{{$post->year}}</td>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="percentage_women_heard_of_FC"]').val(data.percentage_women_heard_of_FC);
                              $('[name="percentage_women_not_heard_of_FC"]').val(data.percentage_women_not_heard_of_FC);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Percentage of women heard of FC</label>
                                <div class="col-md-9">
                                  <input name="percentage_women_heard_of_FC"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Percentage of women not heard of FC</label>
                                <div class="col-md-9">
                                  <input name="percentage_women_not_heard_of_FC"  class="form-control" type="text">
                                </div>
                              </div>
