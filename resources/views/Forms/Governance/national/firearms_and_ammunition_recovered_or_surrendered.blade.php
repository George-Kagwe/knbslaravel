 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Firearms and Ammunition Recovered or Surrendered</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>{{$post->rifles}}</td>
                                                <td>{{$post->pistols}}</td>
                                                <td>{{$post->toy_pistols}}</td>
                                                <td>{{$post->ammunition}}</td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchammunition", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="rifles"]').val(data.rifles);
                              $('[name="pistols"]').val(data.pistols);
                              $('[name="toy_pistols"]').val(data.toy_pistols);
                              $('[name="ammunition"]').val(data.ammunition);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Rifles</label>
                                <div class="col-md-9">
                                  <input name="rifles"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Pistols</label>
                                <div class="col-md-9">
                                  <input name="pistols"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
                                <label class="control-label col-md-3">Toy Pistols</label>
                                <div class="col-md-9">
                                  <input name="toy_pistols"  class="form-control" type="text">
                                </div>
                              </div>

                                <div class="form-group">
                                <label class="control-label col-md-3">Ammunition</label>
                                <div class="col-md-9">
                                  <input name="ammunition"  class="form-control" type="text">
                                </div>
                              </div>
