 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Convicted Prisoners by Type of Offence and Sex</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->convicted_offence_type}}</td>
                                                <td>{{$post->offence}}</td>
                                                <td>{{$post->male}}</td>
                                                <td>{{$post->female}}</td>
                                                <td>{{$post->year}}</td>                                      
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->convicted_offence_type;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchconvictions", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.convicted_offence_type);
