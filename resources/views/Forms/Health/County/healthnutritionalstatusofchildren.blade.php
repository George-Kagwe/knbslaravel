                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health nutritional status of children</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->nutrition_child_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->stunted}}</td>
                                                          <td>{{$post->wasted}}</td>                                      
                                                <td>{{$post->under_weight}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->nutrition_child_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.nutrition_child_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="stunted"]').val(data.stunted);
                              
                              $('[name="wasted"]').val(data.wasted);
                                  $('[name="under_weight"]').val(data.under_weight);                                          
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Stunted</label>
                                <div class="col-md-9">
                                  <input name="stunted"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                <label class="control-label col-md-3">Wasted</label>
                                <div class="col-md-9">
                                  <input name="wasted"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                <label class="control-label col-md-3">Under Weight</label>
                                <div class="col-md-9">
                                  <input name="under_weight"  class="form-control" type="text">
                                </div>
                              </div>
