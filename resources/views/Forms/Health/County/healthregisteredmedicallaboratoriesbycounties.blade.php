                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health registered medical laboratories by counties</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->reg_med_lab_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.reg_med_lab_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="class_a"]').val(data.class_a);
                              
                              $('[name="class_b"]').val(data.class_b);
                              $('[name="class_c"]').val(data.class_c);                          $('[name="class_d"]').val(data.class_d);
                              $('[name="class_e"]').val(data.class_e);
                              $('[name="class_f"]').val(data.class_f);
                              $('[name="unknown"]').val(data.unknown);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">class a</label>
                                <div class="col-md-9">
                                  <input name="class_a"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                <label class="control-label col-md-3">class b</label>
                                <div class="col-md-9">
                                  <input name="class_b"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                <label class="control-label col-md-3">class c</label>
                                <div class="col-md-9">
                                  <input name="class_c"  class="form-control" type="text">
                                </div>
                              </div>

                                    <div class="form-group">
                                <label class="control-label col-md-3">class d</label>
                                <div class="col-md-9">
                                  <input name="class_d"  class="form-control" type="text">
                                </div>
                              </div>

                                <div class="form-group">
                                <label class="control-label col-md-3">class e</label>
                                <div class="col-md-9">
                                  <input name="class_e"  class="form-control" type="text">
                                </div>
                              </div>
                                 <div class="form-group">
                                <label class="control-label col-md-3">class f</label>
                                <div class="col-md-9">
                                  <input name="class_f"  class="form-control" type="text">
                                </div>
                              </div>
                                   <div class="form-group">
                                <label class="control-label col-md-3">unknown</label>
                                <div class="col-md-9">
                                  <input name="unknown"  class="form-control" type="text">
                                </div>
                              </div>
