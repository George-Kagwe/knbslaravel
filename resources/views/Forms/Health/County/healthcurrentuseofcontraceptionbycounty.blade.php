    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health current use of contraception by county</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->contraception_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->any_modem_method}}</td>
                                                      
                                                                                         

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->contraception_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchcontraception", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.contraception_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="any_modem_method"]').val(data.any_modem_method);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">any modern method</label>
                                <div class="col-md-9">
                                  <input name="any_modem_method"  class="form-control" type="text">
                                </div>
                              </div>
