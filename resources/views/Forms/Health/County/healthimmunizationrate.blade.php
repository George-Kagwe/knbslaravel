    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health immunization rate</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->immunization_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchimmunization", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.immunization_id);
