    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health distribution of out patient visits by type of healthcare provider</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->health_facility_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->public}}</td>
                                                          <td>{{$post->private}}</td>                                      
                                                <td>{{$post->faith_based}}</td>
                                                  <td>{{$post->others}}</td>
                                                                                         

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->health_facility_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchprivateN", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.health_facility_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="public"]').val(data.public);
                              
                              $('[name="private"]').val(data.private);
                              $('[name="faith_based"]').val(data.faith_based);                          $('[name="others"]').val(data.others);
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div class="form-group">
                                <label class="control-label col-md-3">faith based</label>
                                <div class="col-md-9">
                                  <input name="faith_based"  class="form-control" type="text">
                                </div>
                              </div>
