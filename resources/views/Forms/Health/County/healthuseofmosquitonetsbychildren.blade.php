    ...
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>health use of mosquito nets by children</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th>                                          
                                           <th>County Name</th>
                                           <th>children under five years who slept under nets last night</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->use_mosquito_net_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->children_under_five_years_who_slept_under_nets_last_night}}</td>
                                                                                             

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->use_mosquito_net_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchmosquito", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.use_mosquito_net_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="children_under_five_years_who_slept_under_nets_last_night"]').val(data.children_under_five_years_who_slept_under_nets_last_night);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">children under five years who slept under nets last night</label>
                                <div class="col-md-9">
                                  <input name="children_under_five_years_who_slept_under_nets_last_night"  class="form-control" type="text">
                                </div>
                              </div>
