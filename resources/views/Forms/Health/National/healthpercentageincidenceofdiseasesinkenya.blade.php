 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Percentage Incidence Of Diseases In Kenya</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->incidence_id}}</td>
                                                <td>{{$post->percentage_incidence}}</td>
                                                <td>{{$post->disease}}</td>
                                                 
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->incidence_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchincidenceN", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.incidence_id);
                              $('[name="percentage_incidence"]').val(data.percentage_incidence);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Percentage Incidence</label>
                                <div class="col-md-9">
                                 
                                 <input name="percentage_incidence" class="form-control" type="text">
                                  @if ($errors->has('percentage_incidence'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('percentage_incidence') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
