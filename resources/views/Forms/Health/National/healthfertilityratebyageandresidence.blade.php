 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Fertility Rate By Age And Residence</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->fertility_id}}</td>
                                                <td>{{$post->fertility_rate}}</td>
                                                <td>{{$post->age_group}}</td>
                                                 <td>{{$post->residence}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->fertility_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchfertility", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.fertility_id);
                              $('[name="fertility_rate"]').val(data.fertility_rate);
                              $('[name="age_group"]').val(data.age_group);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Fertility Rate</label>
                                <div class="col-md-9">
                                 
                                 <input name="fertility_rate" class="form-control" type="text">
                                  @if ($errors->has('fertility_rate'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('fertility_rate') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="age_group"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
                                   <div class="form-group">
                                <label class="control-label col-md-3">Residence</label>
                                <div class="col-md-9">
