 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Fertility By Education Status</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->fertility_id}}</td>
                                                <td>{{$post->fertility}}</td>
                                                <td>{{$post->education_status}}</td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchfertilityN", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="fertility"]').val(data.fertility);
                              $('[name="education_status"]').val(data.education_status);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Fertility</label>
                                <div class="col-md-9">
                                 
                                 <input name="fertility" class="form-control" type="text">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Education Status</label>
                                <div class="col-md-9">
                                  <input name="education_status"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
