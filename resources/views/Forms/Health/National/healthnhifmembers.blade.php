 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Nhif Members</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->nhif_member_id}}</td>
                                                <td>{{$post->formal_sector}}</td>
                                                <td>{{$post->informal_sector}}</td>
                                                <td>{{$post->total}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->nhif_member_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchnhifMember", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.nhif_member_id);
                              $('[name="formal_sector"]').val(data.formal_sector);
                              $('[name="informal_sector"]').val(data.informal_sector);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Formal Sector</label>
                                <div class="col-md-9">
                                 
                                 <input name="formal_sector" class="form-control" type="text">
                                  @if ($errors->has('formal_sector'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('formal_sector') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Informal Sector</label>
                                <div class="col-md-9">
                                  <input name="informal_sector"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
