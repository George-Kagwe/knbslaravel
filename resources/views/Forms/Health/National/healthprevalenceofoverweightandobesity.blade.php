 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Prevalence Of Overweight And Obesity</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->prevalence_id}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->prevalence_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchprevalence", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.prevalence_id);
                              $('[name="age_group"]').val(data.age_group);
                              $('[name="women"]').val(data.women);
                               
                              $('[name="men"]').val(data.men); 
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Women</label>
                                <div class="col-md-9">
                                  <input name="women"  class="form-control" type="text">
                                </div>
                              </div>
                                <div class="form-group">
                                <label class="control-label col-md-3">Men</label>
                                <div class="col-md-9">
                                  <input name="men"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
