                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Health Early Childhood Mortality Rates By Sex</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->rate_id}}</td>
                                                <td>{{$post->mortality_rate}}</td>
                                                <td>{{$post->status}}</td>
                                                 <td>{{$post->gender}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->rate_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.rate_id);
                              $('[name="mortality_rate"]').val(data.mortality_rate);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Mortality Rate</label>
                                <div class="col-md-9">
                                 
                                 <input name="mortality_rate" class="form-control" type="text">
                                  @if ($errors->has('mortality_rate'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('mortality_rate') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
