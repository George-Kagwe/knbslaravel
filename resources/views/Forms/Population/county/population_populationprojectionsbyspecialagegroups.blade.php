    ...
    <div class="right_col" role="main">
                     ...
                     <div class="col-lg-12">
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->selected_age_group_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->under_1}}</td>
                                                <td>{{$post->range_1_2}}</td> 
                                                <td>{{$post->range_3_5}}</td>   
                                                <td>{{$post->range_6_13}}</td>
                                                <td>{{$post->range_14_17}}</td>
                                                <td>{{$post->range_18_24}}</td>
                                                <td>{{$post->range_18_34}}</td>
                                                <td>{{$post->range_less_18}}</td>
                                                <td>{{$post->range_18_plus}}</td>     
                                                <td>{{ $post->range_15_49}}</td>
                                                <td>{{$post->range_15_64}}</td> 
                                                <td>{{$post->range_65_plus}}</td> 
                                                <td>{{$post->gender}}</td>     
                                                <td>{{$post->year}}</td>              
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->selected_age_group_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                                           ...
                                           gender : {
                                              validators: {
                                                  notEmpty: {
                                                   ...
                                                   minLength: {                                                    
                                                    message: 'Must be in text format'
                                                }
                                              }
                                          },
                                           year : {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopSpecialAge", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.selected_age_group_id);
                              $('[name="county_id"]').val(data.county_id);
                              $('[name="under_1"]').val(data.under_1);
                              $('[name="range_1_2"]').val(data.range_1_2  );
                              $('[name="range_3_5"]').val(data.range_3_5);   
                              $('[name="range_6_13"]').val(data.range_6_13);
                              $('[name="range_14_17"]').val(data.range_14_17);
                              $('[name="range_18_24"]').val(data.range_18_24);
                              $('[name="range_18_34"]').val(data.range_18_34);    
                              $('[name="range_less_18"]').val(data.range_less_18);
                              $('[name="range_18_plus"]').val(data.range_18_plus);
                              $('[name="range_15_49"]').val(data.range_15_49);
                              $('[name="range_15_64"]').val(data.range_15_64);
                              $('[name="range_65_plus"]').val(data.range_65_plus);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Under 1 </label>
                                <div class="col-md-9">
                                  <input name="under_1"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Range 1-2</label>
                                <div class="col-md-9">
                                  <input name="range_1_2"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Range 3-5</label>
                                <div class="col-md-9">
                                  <input name="range_3_5"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Range 6-13</label>
                                <div class="col-md-9">
                                  <input name="range_6_13"  class="form-control" type="text">
                                </div>
                              </div>

                                 <div class="form-group">
                                <label class="control-label col-md-3">Range 14-17</label>
                                <div class="col-md-9">
                                  <input name="range_14_17"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Range 18-24</label>
                                <div class="col-md-9">
                                  <input name="range_18_24"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">Range 18-34</label>
                                <div class="col-md-9">
                                  <input name="range_18_34"  class="form-control" type="text">
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-md-3">Range less 18</label>
                                <div class="col-md-9">
                                  <input name="range_less_18"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Range 18 plus</label>
                                <div class="col-md-9">
                                  <input name="range_18_plus"  class="form-control" type="text">
                                </div>
                              </div>

      
                               <div class="form-group">
                                <label class="control-label col-md-3">Range 15-49</label>
                                <div class="col-md-9">
                                  <input name="range_15_49"  class="form-control" type="text">
                                </div>
                              </div>

                         
                                <div class="form-group">
                                <label class="control-label col-md-3">Range 15-64</label>
                                <div class="col-md-9">
                                  <input name="range_15_64"  class="form-control" type="text">
                                </div>
                              </div>

                               <div class="form-group">
                                <label class="control-label col-md-3">Range 65 plus</label>
                                <div class="col-md-9">
                                  <input name="range_65_plus"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
