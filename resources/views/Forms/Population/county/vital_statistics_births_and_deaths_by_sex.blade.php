                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Vital Statistics of Births and Deaths by Sex</center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="births"]').val(data.births);
                              $('[name="deaths"]').val(data.deaths  );
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                         ...
                         <option value="{{$counties->county_id}}">{{$counties->county_name}}</option>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Births</label>
                                <div class="col-md-9">
                                  <input name="births"  class="form-control" type="text">
                                </div>
                              </div>


                              <div class="form-group">
                                <label class="control-label col-md-3">Deaths</label>
                                <div class="col-md-9">
                                  <input name="deaths"  class="form-control" type="text">
                                </div>
                              </div>
