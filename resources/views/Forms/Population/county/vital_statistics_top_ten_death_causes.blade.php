...
<html lang="en">
 ...
 <!-- page content -->
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Top Ten Death Causes</center></h5>
                              <br />
            ...
            <script type="text/javascript">
                    ...
                    $('select[name=county_name]').change(function() {
                        ...
                        $.get(url, function(data) {
                            var select = $('form select[name=cause]');
                            
                            select.empty();

                            $.each(JSON.parse(data),function(key,value) {
                              
                                 select.append('<option value=' + value.cause_id + '>' +value.cause+ '</option>');
                            });
                        });
                    });
                        });
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="cause_id"]').val(data.cause_id);
  ...
  <div class="form-group"  id="categorydiv">
                                ...
                                <div class="col-md-9">
                                  <select class="form-control" id="cause_id" name="cause_id">
                                    <option value="">please select</option>
                                    

                                       <?php foreach($causes as $causes){?>
                                            
                                                 <option value="{{$causes->cause_id}}">{{$causes->cause}}</option>
