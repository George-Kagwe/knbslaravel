 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Household Population by type of Floor Material off Main Dwelling Unit</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_floor_material as $material){?>
                                             <tr>
                                                <td>{{$material->floor_material_id}}</td>
                                                <td>{{$material->material}}</td>
                                                <td>{{$material->households}}</td>
                                                                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $material->floor_material_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationByMainMaterialDwellingUnit", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.floor_material_id);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationByMainMaterialDwellingUnit') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationByMainMaterialDwellingUnit') }}";
                        }
