 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Household Population Percentage ownership household assets</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_hse_percentage as $percent){?>
                                             <tr>
                                                <td>{{$percent->ownership_id}}</td>
                                                <td>{{$percent->asset}}</td>
                                                <td>{{$percent->percentage}}</td>
                                                                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $percent->ownership_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          percentage: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a number up to 5 decimal places'
                                                  },
                                                   message: {                                                    
                                                    message: 'Must be a whole number or a Decimal'
                                                }
                                              }
                                          },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationByHouseholdAsset", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationByHouseholdAsset') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationByHouseholdAsset') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="asset" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
