 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Household Population by main source of Water</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_water_source as $source){?>
                                             <tr>
                                                <td>{{$source->source_of_water_id}}</td>
                                                <td>{{$source->source}}</td>
                                                <td>{{$source->total}}</td>
                                                                                      
                                               <td>
                                                <button class="btn btn-success" onclick="edit(<?php echo $source->source_of_water_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationByMainWaterSource", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.source_of_water_id);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationByMainWaterSource') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationByMainWaterSource') }}";
                        }
