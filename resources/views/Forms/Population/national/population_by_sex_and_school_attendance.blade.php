 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Population by sex and school attendance</center></h5> 
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_by_sex_att as $pop_by_sex_att){?>
                                             <tr>
                                                <td>{{$pop_by_sex_att->attendance_id}}</td>
                                                <td>{{$pop_by_sex_att->education_level}}</td>
                                                <td>{{$pop_by_sex_att->female}}</td>
                                                <td>{{$pop_by_sex_att->male}}</td>
                                                <td>{{$pop_by_sex_att->total_population}}</td>
                                                                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php 
                                                  echo $pop_by_sex_att->attendance_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          education_level: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Enter the Education Level '
                                                  },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationBySexAndAttendance", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.attendance_id);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationBySexAndAttendance') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationBySexAndAttendance') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="education_level" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
