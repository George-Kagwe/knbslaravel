 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Population by type of Disability</center></h5> 
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_by_dis_type as $pop_by_dis_type){?>
                                             <tr>
                                                <td>{{$pop_by_dis_type->disability_id}}</td>
                                                <td>{{$pop_by_dis_type->disability}}</td>
                                                <td>{{$pop_by_dis_type->females}}</td>
                                                <td>{{$pop_by_dis_type->males}}</td>
                                                <td>{{$pop_by_dis_type->total_population}}</td>
                                                                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php 
                                                  echo $pop_by_dis_type->disability_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          females: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Enter No of Female '
                                                  },
                                                  message: {                                     
                                                    message: 'Must be a a number '
                                                },
                                              }
                                          },
                                          males: {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationByDisabilityType", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.disability_id);
                              $('[name="disability"]').val(data.disability);
                              $('[name="females"]').val(data.females);
                              $('[name="males"]').val(data.males);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationByDisabilityType') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationByDisabilityType') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 <input name="disability" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Female</label>
                                <div class="col-md-9">
                                 <input name="females" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Male</label>
                                <div class="col-md-9">
                                 <input name="males" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
