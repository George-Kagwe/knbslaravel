 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Population by sex and age group</center></h5> 
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($pop_by_sex as $pop_by_sex){?>
                                             <tr>
                                                <td>{{$pop_by_sex->group_id}}</td>
                                                <td>{{$pop_by_sex->female}}</td>
                                                <td>{{$pop_by_sex->male}}</td>
                                                <td>{{$pop_by_sex->total_population}}</td>
                                                <td>{{$pop_by_sex->age_group}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $pop_by_sex->group_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPopulationBySexAndGroup", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePopulationBySexAndGroup') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updatePopulationBySexAndGroup') }}";
                        }
