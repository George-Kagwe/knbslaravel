 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Labour Memorandum Items In Public Sector</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->memorandum_item_id}}</td>
                                                 <td>{{$post->memorandum_item}}</td>
                                                <td>{{$post->wage_earnings}}</td>
                                                 
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->memorandum_item_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchmemorandum", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.memorandum_item_id);
                              $('[name="memorandum_item"]').val(data.memorandum_item);
                              $('[name="wage_earnings"]').val(data.wage_earnings);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Memorandum Item</label>
                                <div class="col-md-9">
                                 
                                 <input name="memorandum_item" class="form-control" type="text">
                                  @if ($errors->has('memorandum_item'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('memorandum_item') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Wage Earnings</label>
                                <div class="col-md-9">
                                  <input name="wage_earnings"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
