                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Labour Wage Employment By Industry In Private Sector</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->wage_employment_id}}</td>
                                                 <td>{{$post->private_sector}}</td>
                                                <td>{{$post->wage_employment}}</td>
                                                   
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->wage_employment_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.wage_employment_id);
                              $('[name="private_sector"]').val(data.private_sector);
                              $('[name="wage_employment"]').val(data.wage_employment);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Private Sector</label>
                                <div class="col-md-9">
                                 
                                 <input name="private_sector" class="form-control" type="text">
                                  @if ($errors->has('private_sector'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('private_sector') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Wage Employment</label>
                                <div class="col-md-9">
                                  <input name="wage_employment"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
