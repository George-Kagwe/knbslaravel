 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Labour Total Recorded Employment</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->total_employment_id}}</td>
                                                 <td>{{$post->sector_category}}</td>
                                                <td>{{$post->total_employment}}</td>
                                                 
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->total_employment_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchemployment", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.total_employment_id);
                              $('[name="sector_category"]').val(data.sector_category);
                              $('[name="total_employment"]').val(data.total_employment);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Sector Category</label>
                                <div class="col-md-9">
                                 
                                 <input name="sector_category" class="form-control" type="text">
                                  @if ($errors->has('sector_category'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('sector_category') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Total Employment</label>
                                <div class="col-md-9">
                                  <input name="total_employment"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
