                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>labour Average Wage Earnings Per Employee Public Sector</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->wage_earnings_id}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->wage_earnings_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.wage_earnings_id);
