                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Labour Wage Employment By Industry In Public Sector</center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="public_sector"]').val(data.public_sector);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Public Sector</label>
                                <div class="col-md-9">
                                 
                                 <input name="public_sector" class="form-control" type="text">
                                  @if ($errors->has('public_sector'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('public_sector') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
