 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Manufacturing Per Change In Quantum Indices Of Man Production</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->percentage_change_id}}</td>
                                                 <td>{{$post->commodity}}</td>
                                                <td>{{$post->percentage_change}}</td>
                                                   
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->percentage_change_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchpercentageN", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.percentage_change_id);
                              $('[name="commodity"]').val(data.commodity);
                              $('[name="percentage_change"]').val(data.percentage_change);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Percentage Change</label>
                                <div class="col-md-9">
                                  <input name="percentage_change"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
