                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Manufacturing Quantum Indices Of Manufacturing Production</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->quantum_indice_id}}</td>
                                                 <td>{{$post->commodity}}</td>
                                                <td>{{$post->quantum_indice}}</td>
                                                   
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->quantum_indice_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.quantum_indice_id);
                              $('[name="commodity"]').val(data.commodity);
                              $('[name="quantum_indice"]').val(data.quantum_indice);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Quantum Indice</label>
                                <div class="col-md-9">
                                  <input name="quantum_indice"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
