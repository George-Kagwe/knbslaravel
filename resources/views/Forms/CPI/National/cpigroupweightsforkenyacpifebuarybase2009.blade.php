                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Cpi Group Weights For Kenya CPI Febuary Base 2009</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                              ...
                                              <td>{{$post->group_weights}}</td>                                                                    
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->group_weights_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.group_weights_id);
