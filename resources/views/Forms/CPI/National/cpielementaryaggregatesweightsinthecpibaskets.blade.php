...
<html lang="en">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Cpi Elementary Aggregates Weights In The Cpi Baskets</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Description</th>
                                            <th>Nairobi Lower</th>
                                            <th>Nairobi Middle</th>
                                            <th>Nairobi Upper</th>
                                            <th>Rest Of Urban Areas</th>
                                            <th>Kenya</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                              <td>{{$post->aggregate_weights_id}}</td>
                                              <td>{{$post->coicop_code}}</td>
                                              <td>{{$post->description}}</td>
                                              <td>{{$post->nairobi_lower}}</td>
                                              <td>{{$post->nairobi_middle}}</td>                                                                    <td>{{$post->nairobi_upper}}</td> 
                                              <td>{{$post->rest_of_urban_areas}}</td> 
                                              <td>{{$post->kenya}}</td> 
                                             
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->aggregate_weights_id;?>)">Update Record</button>
 ...
 kenya: {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchaggregate", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.aggregate_weights_id);
                              $('[name="coicop_code"]').val(data.coicop_code);
                              $('[name="description"]').val(data.description);
                              $('[name="nairobi_lower"]').val(data.nairobi_lower);
                              $('[name="nairobi_middle"]').val(data.nairobi_middle);
                              $('[name="nairobi_upper"]').val(data.nairobi_upper);
                              $('[name="rest_of_urban_areas"]').val(data.rest_of_urban_areas);
                              $('[name="kenya"]').val(data.kenya);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Coicop Code</label>
                                <div class="col-md-9">
                                 
                                 <input name="coicop_code" class="form-control" type="text">
                                  @if ($errors->has('coicop_code'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('coicop_code') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">Nairobi Lower</label>
                                <div class="col-md-9">
                                  <input name="nairobi_lower"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Nairobi Middle</label>
                                <div class="col-md-9">
                                  <input name="nairobi_middle"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Nairobi Upper</label>
                                <div class="col-md-9">
                                  <input name="nairobi_upper"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Rest Of Urban Areas</label>
                                <div class="col-md-9">
                                  <input name="rest_of_urban_areas"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Kenya</label>
                                <div class="col-md-9">
                                  <input name="kenya"  class="form-control" type="text">
                                </div>
                              </div>
