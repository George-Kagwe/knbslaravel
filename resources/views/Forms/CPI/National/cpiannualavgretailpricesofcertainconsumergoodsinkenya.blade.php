                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>CPI Annual Average Retail Prices Of Certain Consumer Goods In Kenya</center></h5>
                              <br />
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                               <td>{{$post->avg_retail_price_id}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->avg_retail_price_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.avg_retail_price_id);
                              $('[name="item"]').val(data.item);
                              $('[name="unit"]').val(data.unit);
                               $('[name="ksh_per_unit"]').val(data.ksh_per_unit);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">Ksh Per Unit</label>
                                <div class="col-md-9">
                                  <input name="ksh_per_unit"  class="form-control" type="text">
                                </div>
                              </div>
                              </div>
