                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Cpi Group Weights For Kenya Cpi October Base 1997</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                              <td>{{$post->group_weight_id}}</td>
                                              
                                              <td>{{$post->item_group}}</td>
                                              <td>{{$post->household}}</td>
                                              <td>{{$post->group_weights}}</td>                                                                    
                                             
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->group_weight_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.group_weight_id);
                              $('[name="item_group"]').val(data.item_group);
                              $('[name="household"]').val(data.household);
                              $('[name="group_weights"]').val(data.group_weights);
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 ...
                                 <input name="item_group" class="form-control" type="text">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Household</label>
                                <div class="col-md-9">
                                  <input name="household"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3">Group Weights</label>
                                <div class="col-md-9">
                                  <input name="group_weights"  class="form-control" type="text">
                                </div>
                              </div>
