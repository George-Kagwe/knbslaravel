                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Poverty Food Estimates by residence and county</center></h5>
                              <br />
...
$(document).ready( function () {
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchPovertyFoodEstimatebyResAndCounty", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storePovertyFoodEstimatebyResAndCounty') }}";
                        ...
                        else
                        {
                          ...
                          url = "{{ route('updatePovertyFoodEstimatebyResAndCounty') }}";
                        }
