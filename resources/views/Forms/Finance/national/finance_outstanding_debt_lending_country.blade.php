                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Outsatnding Debt And Lending Country</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->lending_country_id}}</td>
                                                <td>{{$post->germany}}</td>
                                                <td>{{$post->japan}}</td>
                                                <td>{{$post->france}}</td>
                                                <td>{{$post->usa}}</td>
                                                <td>{{$post->netherlands}}</td>
                                                <td>{{$post->denmark}}</td>
                                                <td>{{$post->finland}}</td>
                                                <td>{{$post->china}}</td>
                                                <td>{{$post->belgium}}</td>
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->lending_country_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.lending_country_id);
                              $('[name="germany"]').val(data.germany);
                              $('[name="japan"]').val(data.japan);
                              $('[name="france"]').val(data.france);
                              $('[name="usa"]').val(data.usa);
                              $('[name="netherlands"]').val(data.netherlands);
                              $('[name="denmark"]').val(data.denmark);
                              $('[name="finland"]').val(data.finland);
                              $('[name="china"]').val(data.china);
                         
                              $('[name="belgium"]').val(data.belgium);
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                 ...
                                 <input name="germany" class="form-control" type="text">
                                  @if ($errors->has('germany'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('germany') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="usa"  class="form-control" type="text">
                                   ...
                                   <div class="form-group">
                                <label class="control-label col-md-3">Netherlands</label>
                                <div class="col-md-9">
                                  <input name="netherlands"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">Denmark</label>
                                <div class="col-md-9">
                                  <input name="denmark"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">Finland</label>
                                <div class="col-md-9">
                                  <input name="finland"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">China</label>
                                <div class="col-md-9">
                                  <input name="china"  class="form-control" type="text">
                                </div>
                              </div>

                                   <div class="form-group">
                                <label class="control-label col-md-3">Belgium</label>
                                <div class="col-md-9">
                                  <input name="belgium"  class="form-control" type="text">
                                </div>
                              </div>
