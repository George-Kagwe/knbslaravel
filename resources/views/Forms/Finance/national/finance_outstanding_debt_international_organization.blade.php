                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Finance Outstanding Debt International Organization</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->outstanding_debt_id}}</td>
                                                <td>{{$post->ida}}</td>
                                                <td>{{$post->eec_eib}}</td>
                                                <td>{{$post->imf}}</td>
                                                <td>{{$post->adf_adb}}</td>
                                            
                                                <td>{{$post->commercial_banks}}</td>
                                                    <td>{{$post->others}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->outstanding_debt_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.outstanding_debt_id);
                              $('[name="ida"]').val(data.ida);
                              $('[name="eec_eib"]').val(data.eec_eib);
                              $('[name="imf"]').val(data.imf);
                              $('[name="adf_adb"]').val(data.adf_adb);
                   
                              $('[name="commercial_banks"]').val(data.commercial_banks);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">IDA</label>
                                <div class="col-md-9">
                                 
                                 <input name="ida" class="form-control" type="text">
                                  @if ($errors->has('ida'))
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">EEC-EIB</label>
                                <div class="col-md-9">
                                  <input name="eec_eib"  class="form-control" type="text">
                                </div>
                              </div>
                              
                                  <div class="form-group">
                                <label class="control-label col-md-3">IMF</label>
                                <div class="col-md-9">
                                  <input name="imf"  class="form-control" type="text">
                                </div>
                              </div>

                                  <div class="form-group">
                                <label class="control-label col-md-3">ADF-ADB</label>
                                <div class="col-md-9">
                                  <input name="adf_adb"  class="form-control" type="text">
                                </div>
                              </div>
                                  ...
                                  <div class="form-group">
                                <label class="control-label col-md-3">Commercial Banks</label>
                                <div class="col-md-9">
                                  <input name="commercial_banks"  class="form-control" type="text">
                                </div>
                              </div>
