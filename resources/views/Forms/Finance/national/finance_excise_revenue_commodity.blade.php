 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Finance Excise Revenue for Commodity</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Cigarettes</th>
                                           <th>Mineral Water</th>
                                           <th>Wines and Spirits</th>
                                          <th>Other Commodities</th>
                                            <th>Total</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->excise_id}}</td>
                                                <td>{{$post->beer}}</td>
                                                <td>{{$post->cigarettes}}</td>
                                                <td>{{$post->mineral_waters}}</td>
                                                <td>{{$post->wines_spirits}}</td>
                                                <td>{{$post->other_commodities}}</td>
                                                <td>{{$post->total}}</td>
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->excise_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchCommodity", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.excise_id);
                              $('[name="beer"]').val(data.beer);
                              $('[name="cigarettes"]').val(data.cigarettes);
                              $('[name="mineral_waters"]').val(data.mineral_waters);
                              $('[name="wines_spirits"]').val(data.wines_spirits);
                              $('[name="other_commodities"]').val(data.other_commodities);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Beer</label>
                                <div class="col-md-9">
                                 
                                 <input name="beer" class="form-control" type="text">
                                  @if ($errors->has('beer'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('beer') }}</strong>
                                    </span>
                                @endif
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Cigarettes</label>
                                <div class="col-md-9">
                                  <input name="cigarettes"  class="form-control" type="text">
                                </div>
                              </div>
                              
                                  <div class="form-group">
                                <label class="control-label col-md-3">Mineral Water</label>
                                <div class="col-md-9">
                                  <input name="mineral_waters"  class="form-control" type="text">
                                </div>
                              </div>

                                  <div class="form-group">
                                <label class="control-label col-md-3">Wines and Spirits</label>
                                <div class="col-md-9">
                                  <input name="wines_spirits"  class="form-control" type="text">
                                </div>
                              </div>

                                  <div class="form-group">
                                <label class="control-label col-md-3">Other Commodities</label>
                                <div class="col-md-9">
                                  <input name="other_commodities"  class="form-control" type="text">
                                </div>
                              </div>
