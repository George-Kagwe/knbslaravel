 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Tourist Departures</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <tbody>
                                      <?php foreach($departures as $departures){?>
                                             <tr>
                                                <td>{{$departures->departures_id}}</td>
                                                <td>{{$departures->quarter}}</td>
                                                <td>{{$departures->holiday}}</td>
                                                <td>{{$departures->business}}</td>
                                                <td>{{$departures->transit}}</td>
                                                <td>{{$departures->other}}</td>
                                                <td>{{$departures->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $departures->departures_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          quarter: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a specific quarter of the year '
                                                  },
                                                   stringLength: {
                                                   		min:2,                                                    
                                                  }
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTouristDepartures", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.departures_id);
                              $('[name="quarter"]').val(data.quarter);
							                $('[name="holiday"]').val(data.holiday);
                              $('[name="business"]').val(data.business);
                              $('[name="transit"]').val(data.transit);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTouristDepartures') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTouristDepartures') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                <label class="control-label col-md-3">Quarter</label>
                                <div class="col-md-9">
                                 <input name="quarter" class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3">Transit</label>
                                <div class="col-md-9">
                                  <input name="transit"  class="form-control" type="text">
                                </div>
                              </div>
                               <div class="form-group">
