 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Tourism Conferences</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($conferences as $conference){?>
                                             <tr>
                                                ...
                                                <td>{{$conference->number_of_conferences}}</td>
                                                <td>{{$conference->number_of_delegates}}</td>
                                                <td>{{$conference->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $conference->conference_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          category: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a specific category '
                                                  },
                                                   stringLength: {
                                                   		min:2,                                                    
                                                  }
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTouristConferences", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.conference_id);
                              $('[name="category"]').val(data.category);
							                $('[name="number_of_conferences"]').val(data.number_of_conferences);
                              $('[name="number_of_delegates"]').val(data.number_of_delegates);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTouristConferences') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTouristConferences') }}";
                        }
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">Number of Conferences</label>
                                <div class="col-md-9">
                                  <input name="number_of_conferences"  class="form-control" type="text">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-md-3">Number of Delegates</label>
                                <div class="col-md-9">
                                  <input name="number_of_delegates"  class="form-control" type="text">
                                </div>
                              </div>
