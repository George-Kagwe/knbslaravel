 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Tourism Arrivals</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($arrivals as $arrival){?>
                                             <tr>
                                                <td>{{$arrival->arrivals_id}}</td>
                                                <td>{{$arrival->quarter}}</td>
                                                <td>{{$arrival->holiday}}</td>
                                                <td>{{$arrival->business}}</td>
                                                <td>{{$arrival->transit}}</td>
                                                <td>{{$arrival->other}}</td>
                                                <td>{{$arrival->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $arrival->arrivals_id;?>)">Update Record</button>
            ...
            <script type="text/javascript">
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTouristArrivals", ":id") }}';
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTouristArrivals') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTouristArrivals') }}";
                        }
