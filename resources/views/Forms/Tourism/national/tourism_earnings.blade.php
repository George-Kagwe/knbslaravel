 ...
 <!-- page content -->
    <div class="right_col" role="main">
                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Tourism Earnings</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ID</th> 
                                           <th>Tourism Earnings in Billions</th>                   
                                           <th>Year</th>
                                      ...
                                      <tbody>
                                      <?php foreach($earnings as $earnings){?>
                                             <tr>
                                                <td>{{$earnings->earnings_id}}</td>
                                                <td>{{$earnings->tourism_earnings_billions}}</td>
                                                <td>{{$earnings->year}}</td>                                      
                                               <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $earnings->earnings_id;?>)">Update Record</button> </td>
            ...
            <script type="text/javascript">
                        ...
                        $('#form').bootstrapValidator({
                                      ...
                                      fields: {
                                          ...
                                          tourism_earnings_billions: {
                                              validators: {
                                                  notEmpty: {
                                                      message: 'Please enter a figure in billions '
                                                  },
                                                   numeric: {                                                    
                                                    message: 'Must be a number Figure also allowed to 2 decimal places'
                                                }
                                              }
                                          },
                      ...
                      function edit(id)
                      {
                        var url = '{{ route("fetchTouristEarnings", ":id") }}';
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.earnings_id);
                              $('[name="tourism_earnings_billions"]').val(data.tourism_earnings_billions);
                      ...
                      function save()
                      {
                        ...
                        if(save_method == 'add')
                        {
                            url = "{{ route('storeTouristEarnings') }}";

                        }
                        else
                        {
                         
                          url = "{{ route('updateTouristEarnings') }}";
                        }
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                <label class="control-label col-md-3">Tourism earnings in billions</label>
                                <div class="col-md-9">
                                 <input name="tourism_earnings_billions" class="form-control" type="text">
                                </div>
                              </div>
