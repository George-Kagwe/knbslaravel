                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Primary Schools by Category and Subcounty</center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->primary_schools_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->subcounty_name}}</td>
                                                <td>{{$post->no_of_schools}}</td>      
                                                <td>{{$post->category}}</td>                                         
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->primary_schools_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.primary_schools_id);
                              $('[name="county_name"]').val(data.county_id);
                              $('[name="subcounty_name"]').val(data.subcounty_id);
                              $('[name="no_of_schools"]').val(data.no_of_schools);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">No of Schools</label>
                                <div class="col-md-9">
                                  <input name="no_of_schools"  class="form-control" type="text">
                                </div>
                              </div>
