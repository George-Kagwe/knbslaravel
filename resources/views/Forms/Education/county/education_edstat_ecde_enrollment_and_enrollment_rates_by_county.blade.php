                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Enrollement Rates by County </center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>ECDE Enrollment</th>    
                                            <th>Gross Enrollment Rate</th> 
                                            <th>Net Enrollment Rate</th>
                                            <th>Gender</th>  
                                           <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->ecde_enrollment_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->ecde_enrollment}}</td>   
                                                ...
                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->ecde_enrollment_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.ecde_enrollment_id);
                              $('[name="county_name"]').val(data.county_id);
                              $('[name="ecde_enrollment"]').val(data.ecde_enrollment);
                                ...
                                <div class="col-md-9">
                                  <select class="form-control" id="county_name" name="county_name">
                                    <option value="">please select</option>
                                      ...
                                      <div class="form-group">
                                <label class="control-label col-md-3">ECDE Enrollment</label>
                                <div class="col-md-9">
                                  <input name="ecde_enrollment"  class="form-control" type="text">
                                </div>
                              </div>
