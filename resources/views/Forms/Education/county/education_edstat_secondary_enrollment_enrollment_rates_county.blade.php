                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>Secondary Enrollment Rates by County </center></h5>
                              <br />
                              ...
                              <table id="table_id" class="table table-striped table-bordered" cellspacing="0"       width="100%">
                                      <thead>
                                        <tr>
                                           ...
                                           <th>Secondary Enrollment</th>    
                                            <th>Gross Enrollment</th> 
                                            <th>Net Enrollment</th>
                                            <th>Gender</th>  
                                           <th>Year</th>
                                      ...
                                      <?php foreach($post as $post){?>
                                             <tr>
                                                <td>{{$post->secondary_enrollment_id}}</td>
                                                <td>{{$post->county_name}}</td>
                                                <td>{{$post->secondary_enrollment}}</td>   
                                                <td>{{$post->gross_enrollment_rate}}</td> 
                                                <td>{{$post->net_enrollment_rate}}</td>  
                                                <td>{{$post->gender}}</td> 
                                                                                            
                                                <td>{{$post->year}}</td>                                      

                                                <td>
                                                  <button class="btn btn-success" onclick="edit(<?php echo $post->secondary_enrollment_id;?>)">Update Record</button>
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="id"]').val(data.secondary_enrollment_id);
                              $('[name="county_name"]').val(data.county_id);
                              $('[name="secondary_enrollment"]').val(data.secondary_enrollment);
                              $('[name="gross_enrollment_rate"]').val(data.gross_enrollment_rate);
                              $('[name="net_enrollment_rate"]').val(data.net_enrollment_rate);
                        ...
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <select class="form-control" id="county_name" name="county_name">
                                    <option value="">please select</option>
                                      ...
                                      <div class="form-group">
                                <label class="control-label col-md-3">Secondary Enrollment</label>
                                <div class="col-md-9">
                                  <input name="secondary_enrollment"  class="form-control" type="text">
                                </div>
                              </div>
                              
                                      <div class="form-group">
                                <label class="control-label col-md-3">Gross Enrollment Rate</label>
                                <div class="col-md-9">
                                  <input name="gross_enrollment_rate"  class="form-control" type="text">
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3">Net Enrollment Rate</label>
                                <div class="col-md-9">
                                  <input name="net_enrollment_rate"  class="form-control" type="text">
                                </div>
                              </div>
