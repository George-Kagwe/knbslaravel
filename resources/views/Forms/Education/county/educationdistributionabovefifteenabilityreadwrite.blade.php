                ...
                <div class="container" style="background:#ffffff">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                              ...
                              <h5><center>education distribution above fifteen ability readwrite</center></h5>
                              <br />
                      ...
                      function edit(id)
                      {
                        ...
                        $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              $('[name="literate"]').val(data.literate);
                              $('[name="illiterate"]').val(data.illiterate);
                      ...
                      <form action="#" id="form" class="form-horizontal">
                        <div class="alert alert-danger" style="display:none"></div>
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3">literate</label>
                                <div class="col-md-9">
                                  <input name="literate"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
                                <label class="control-label col-md-3">illiterate</label>
                                <div class="col-md-9">
                                  <input name="illiterate"  class="form-control" type="text">
                                </div>
                              </div>
                                  <div class="form-group">
